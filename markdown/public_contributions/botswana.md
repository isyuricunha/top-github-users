...
The `public contributions` by users in Botswana on `2023/1/5 2:17 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
