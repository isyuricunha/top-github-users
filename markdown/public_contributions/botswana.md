...
The `public contributions` by users in Botswana on `2023/1/23 4:17 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
