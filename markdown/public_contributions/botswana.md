...
The `public contributions` by users in Botswana on `2022/12/8 9:52 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
