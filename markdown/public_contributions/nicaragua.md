...
The `public contributions` by users in Nicaragua on `2022/12/13 5:34 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
