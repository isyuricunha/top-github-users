...
The `public contributions` by users in Finland on `2023/10/18 9:42 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
