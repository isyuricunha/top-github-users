...
The `public contributions` by users in Finland on `2024/11/7 5:40 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
