...
The `public contributions` by users in Finland on `2024/1/20 6:56 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
