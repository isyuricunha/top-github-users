...
The `public contributions` by users in Finland on `2025/12/31 1:16 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
