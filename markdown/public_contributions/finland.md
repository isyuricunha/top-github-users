...
The `public contributions` by users in Finland on `2024/12/2 9:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
