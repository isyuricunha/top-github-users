...
The `public contributions` by users in Finland on `2023/1/3 1:28 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
