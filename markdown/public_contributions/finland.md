...
The `public contributions` by users in Finland on `2024/12/6 11:48 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
