...
The `public contributions` by users in Finland on `2024/12/16 2:55 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
