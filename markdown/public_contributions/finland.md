...
The `public contributions` by users in Finland on `2023/12/30 11:57 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `952 users`  in Finland. You need at least `37 followers` to be on this list.
