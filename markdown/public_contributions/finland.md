...
The `public contributions` by users in Finland on `2023/6/1 8:35 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
