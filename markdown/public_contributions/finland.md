...
The `public contributions` by users in Finland on `2023/4/29 9:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
