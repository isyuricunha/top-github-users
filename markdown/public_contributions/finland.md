...
The `public contributions` by users in Finland on `2024/4/2 9:30 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
