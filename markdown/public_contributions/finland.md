...
The `public contributions` by users in Finland on `2023/3/23 8:57 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
