...
The `public contributions` by users in Finland on `2024/10/17 2:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
