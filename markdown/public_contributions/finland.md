...
The `public contributions` by users in Finland on `2024/4/30 7:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
