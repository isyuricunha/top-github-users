...
The `public contributions` by users in Finland on `2023/5/9 11:30 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
