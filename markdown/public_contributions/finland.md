...
The `public contributions` by users in Finland on `2023/1/22 6:20 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
