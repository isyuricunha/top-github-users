...
The `public contributions` by users in Finland on `2023/1/7 6:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
