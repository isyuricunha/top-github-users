...
The `public contributions` by users in Finland on `2024/8/1 11:19 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
