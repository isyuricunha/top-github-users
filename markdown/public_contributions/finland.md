...
The `public contributions` by users in Finland on `2023/10/27 6:21 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
