...
The `public contributions` by users in Finland on `2023/12/14 5:57 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
