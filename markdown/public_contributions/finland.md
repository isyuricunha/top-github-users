...
The `public contributions` by users in Finland on `2023/5/21 8:41 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
