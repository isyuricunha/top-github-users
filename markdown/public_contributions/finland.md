...
The `public contributions` by users in Finland on `2024/2/17 9:15 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
