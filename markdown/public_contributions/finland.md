...
The `public contributions` by users in Finland on `2023/1/14 7:44 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
