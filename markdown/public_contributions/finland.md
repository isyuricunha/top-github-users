...
The `public contributions` by users in Finland on `2024/9/7 3:19 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
