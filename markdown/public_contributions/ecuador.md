...
The `public contributions` by users in Ecuador on `2022/12/30 9:29 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
