...
The `public contributions` by users in Ecuador on `2023/7/8 6:18 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
