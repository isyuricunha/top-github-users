...
The `public contributions` by users in Ecuador on `2023/10/7 6:19 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
