...
The `public contributions` by users in Ecuador on `2023/3/19 7:40 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
