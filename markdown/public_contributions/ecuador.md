...
The `public contributions` by users in Ecuador on `2023/4/21 9:30 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
