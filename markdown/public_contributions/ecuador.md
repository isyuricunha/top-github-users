...
The `public contributions` by users in Ecuador on `2024/8/12 9:36 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
