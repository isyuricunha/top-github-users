...
The `public contributions` by users in Ecuador on `2022/11/27 6:39 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
