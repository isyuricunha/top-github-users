...
The `public contributions` by users in Ecuador on `2023/1/14 6:36 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
