...
The `public contributions` by users in Ecuador on `2023/11/30 8:45 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
