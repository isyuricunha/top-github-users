...
The `public contributions` by users in Ecuador on `2022/11/13 5:09 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
