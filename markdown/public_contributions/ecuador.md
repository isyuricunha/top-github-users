...
The `public contributions` by users in Ecuador on `2022/11/15 11:44 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
