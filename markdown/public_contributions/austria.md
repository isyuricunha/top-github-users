...
The `public contributions` by users in Austria on `2024/1/22 2:40 AM UTC`. This list contains users from `Austria` and cities `Vienna` `Salzburg` `Innsbruck` `Linz` `Graz` `Klagenfurt` `Bregenz` `Villach`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `955 users`  in Austria. You need at least `37 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Roland_Dreger">Roland_Dreger</a></td>
		<td>Vienna</td>
		<td>13</td>
	</tr>
	<tr>
