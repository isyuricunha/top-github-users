...
The `public contributions` by users in Belgium on `2024/6/15 2:36 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>307</td>
		<td>
			<a href="https://github.com/koenvaneijk">
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/koenvaneijk">koenvaneijk</a></td>
		<td>Belgium</td>
		<td>196</td>
	</tr>
	<tr>
