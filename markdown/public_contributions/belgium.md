...
The `public contributions` by users in Belgium on `2023/11/11 3:42 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `971 users`  in Belgium. You need at least `35 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Paircoaching </td>
		<td><a href="https://twitter.com/YvesHanoulle">YvesHanoulle</a></td>
		<td>Ghent</td>
		<td>23</td>
	</tr>
	<tr>
