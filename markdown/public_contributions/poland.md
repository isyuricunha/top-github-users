...
The `public contributions` by users in Poland on `2023/1/13 6:43 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
