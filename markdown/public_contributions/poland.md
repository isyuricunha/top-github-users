...
The `public contributions` by users in Poland on `2023/11/8 6:22 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
