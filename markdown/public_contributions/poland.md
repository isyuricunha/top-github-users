...
The `public contributions` by users in Poland on `2023/7/13 9:19 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
