...
The `public contributions` by users in Norway on `2023/12/19 10:32 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
