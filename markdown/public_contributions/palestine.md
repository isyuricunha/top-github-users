...
The `public contributions` by users in Palestine on `2023/11/12 2:55 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
