...
The `public contributions` by users in Palestine on `2023/10/7 9:40 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
