...
The `public contributions` by users in Madagascar on `2024/10/1 6:49 PM UTC`. This list contains users from `Madagascar` and cities `Antananarivo` `Toamasina` `Mahajanga` `Antsirabe`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Ambanidia, Antananarivo, Madagascar</td>
		<td>87</td>
	</tr>
	<tr>
		<td>220</td>
