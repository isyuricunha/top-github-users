...
The `public contributions` by users in Madagascar on `2024/7/8 10:34 PM UTC`. This list contains users from `Madagascar` and cities `Antananarivo` `Toamasina` `Mahajanga` `Antsirabe`.
...
<table>
	...
	<tr>
		<td>580</td>
		<td>
			<a href="https://github.com/FenoDevfront">
				<img src="https://avatars.githubusercontent.com/u/171813817?s=72&v=4" width="24" alt="Avatar of FenoDevfront"> FenoDevfront
			</a><br/>
			Feno Niaina Ratsimbaharisoa
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Antananarivo,Analamanga,Madagascar </td>
