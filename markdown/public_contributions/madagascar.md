...
The `public contributions` by users in Madagascar on `2024/11/28 1:09 PM UTC`. This list contains users from `Madagascar` and cities `Antananarivo` `Toamasina` `Mahajanga` `Antsirabe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/antonioramana">
				<img src="https://avatars.githubusercontent.com/u/102760708?s=72&v=4" width="24" alt="Avatar of antonioramana"> antonioramana
			</a><br/>
