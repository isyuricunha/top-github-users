...
The `public contributions` by users in Serbia on `2024/10/12 10:57 AM UTC`. This list contains users from `Serbia` and cities `Belgrade`.
...
<table>
	...
	<tr>
		<td>688</td>
		<td>
			<a href="https://github.com/PSIXO">
				<img src="https://avatars.githubusercontent.com/u/1736857?s=72&v=4" width="24" alt="Avatar of PSIXO"> PSIXO
			</a><br/>
			Igor Čordaš
		</td>
		<td>Appsolutistta </td>
