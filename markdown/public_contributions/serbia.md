...
The `public contributions` by users in Serbia on `2024/6/12 5:34 PM UTC`. This list contains users from `Serbia` and cities `Belgrade`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/stefan2do">
				<img src="https://avatars.githubusercontent.com/u/164066178?s=72&v=4" width="24" alt="Avatar of stefan2do"> stefan2do
			</a><br/>
			Stefan Todorovic
		</td>
		<td>Adisoft </td>
