...
The `public contributions` by users in Jordan on `2025/1/4 5:36 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
