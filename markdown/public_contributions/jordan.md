...
The `public contributions` by users in Jordan on `2024/8/7 5:35 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
