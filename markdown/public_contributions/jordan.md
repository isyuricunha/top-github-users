...
The `public contributions` by users in Jordan on `2023/2/15 3:37 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
