...
The `public contributions` by users in Jordan on `2024/5/9 2:41 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
