...
The `public contributions` by users in Jordan on `2024/9/27 3:37 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
