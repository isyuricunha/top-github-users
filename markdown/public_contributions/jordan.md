...
The `public contributions` by users in Jordan on `2024/11/28 10:22 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
