...
The `public contributions` by users in Jordan on `2024/7/5 8:37 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
