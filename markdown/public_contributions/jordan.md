...
The `public contributions` by users in Jordan on `2023/1/18 6:57 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
