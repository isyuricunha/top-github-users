...
The `public contributions` by users in Jordan on `2023/6/6 6:18 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
