...
The `public contributions` by users in Jordan on `2023/1/22 11:28 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
