...
The `public contributions` by users in Jordan on `2024/8/14 1:37 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
