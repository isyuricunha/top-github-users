...
The `public contributions` by users in Jordan on `2024/5/28 6:38 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
