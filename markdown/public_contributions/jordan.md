...
The `public contributions` by users in Jordan on `2024/8/16 10:19 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
