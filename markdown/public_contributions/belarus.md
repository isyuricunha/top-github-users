...
The `public contributions` by users in Belarus on `2022/11/12 5:09 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
