...
The `public contributions` by users in Sierra Leone on `2024/6/25 4:39 AM UTC`. This list contains users from `Sierra Leone` and cities `Freetown`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `266 users`  in Sierra Leone. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AbuJrVandi">
				<img src="https://avatars.githubusercontent.com/u/173740671?s=72&v=4" width="24" alt="Avatar of AbuJrVandi"> AbuJrVandi
			</a><br/>
			ABU JUNIOR VANDI
		</td>
