...
The `public contributions` by users in Argentina on `2025/2/6 2:24 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `963 users`  in Argentina. You need at least `52 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Argentina, Odessa, Italy, Earth, the Universe (or God)</td>
		<td>1500</td>
	</tr>
	<tr>
		<td>20</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/stormwatch">
				<img src="https://avatars.githubusercontent.com/u/824211?s=72&u=cd94e87200c4dc0b899937cf4b3357d5fe50d24d&v=4" width="24" alt="Avatar of stormwatch"> stormwatch
			</a><br/>
			Ezequiel Birman
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/ezebirman">ezebirman</a></td>
		<td>Argentina</td>
		<td>47</td>
	</tr>
	<tr>
