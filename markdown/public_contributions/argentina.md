...
The `public contributions` by users in Argentina on `2023/6/27 1:08 AM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `979 users`  in Argentina. You need at least `39 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tadeodonegana">
				<img src="https://avatars.githubusercontent.com/u/75747222?s=72&u=2aecf19f5b27e5380248dfbc0682d16cbbfb0366&v=4" width="24" alt="Avatar of tadeodonegana"> tadeodonegana
			</a><br/>
