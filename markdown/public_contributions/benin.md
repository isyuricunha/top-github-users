...
The `public contributions` by users in Benin on `2024/7/15 12:59 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		<td>310</td>
		<td>
			<a href="https://github.com/Rexki">
				<img src="https://avatars.githubusercontent.com/u/175165792?s=72&v=4" width="24" alt="Avatar of Rexki"> Rexki
			</a><br/>
			Rexki
		</td>
		<td>Edo Hub </td>
