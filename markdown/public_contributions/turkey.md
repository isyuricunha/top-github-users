...
The `public contributions` by users in Turkey on `2023/6/14 11:27 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
