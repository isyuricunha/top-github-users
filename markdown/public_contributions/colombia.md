...
The `public contributions` by users in Colombia on `2023/8/20 4:17 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
