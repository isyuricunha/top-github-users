...
The `public contributions` by users in Colombia on `2024/1/13 3:30 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
