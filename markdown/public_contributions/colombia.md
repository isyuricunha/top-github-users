...
The `public contributions` by users in Colombia on `2023/8/21 6:33 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
