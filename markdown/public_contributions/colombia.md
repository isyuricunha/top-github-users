...
The `public contributions` by users in Colombia on `2023/6/9 8:42 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
