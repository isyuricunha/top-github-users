...
The `public contributions` by users in Colombia on `2024/11/21 1:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
