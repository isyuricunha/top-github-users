...
The `public contributions` by users in Colombia on `2023/12/14 1:50 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
