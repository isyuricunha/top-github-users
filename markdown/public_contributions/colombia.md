...
The `public contributions` by users in Colombia on `2023/2/16 2:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
