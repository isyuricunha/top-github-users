...
The `public contributions` by users in Colombia on `2024/12/6 7:20 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
