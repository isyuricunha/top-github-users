...
The `public contributions` by users in Colombia on `2023/10/27 2:35 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
