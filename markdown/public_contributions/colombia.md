...
The `public contributions` by users in Colombia on `2022/11/1 3:03 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
