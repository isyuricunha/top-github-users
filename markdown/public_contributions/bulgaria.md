...
The `public contributions` by users in Bulgaria on `2023/4/29 3:15 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
