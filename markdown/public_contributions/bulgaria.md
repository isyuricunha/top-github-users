...
The `public contributions` by users in Bulgaria on `2023/9/28 4:38 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
