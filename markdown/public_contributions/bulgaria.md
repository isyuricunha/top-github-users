...
The `public contributions` by users in Bulgaria on `2024/9/1 1:23 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
