...
The `public contributions` by users in Bulgaria on `2024/7/13 4:37 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
