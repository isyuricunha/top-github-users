...
The `public contributions` by users in Bulgaria on `2023/8/31 11:42 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
