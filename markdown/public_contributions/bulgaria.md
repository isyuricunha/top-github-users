...
The `public contributions` by users in Bulgaria on `2024/12/15 4:59 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
