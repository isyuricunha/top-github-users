...
The `public contributions` by users in Bulgaria on `2025/1/21 2:23 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
