...
The `public contributions` by users in Bulgaria on `2023/1/27 9:32 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
