...
The `public contributions` by users in Bulgaria on `2025/1/10 4:43 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
