...
The `public contributions` by users in Bulgaria on `2024/7/8 6:48 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
