...
The `public contributions` by users in Bulgaria on `2024/8/30 4:22 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
