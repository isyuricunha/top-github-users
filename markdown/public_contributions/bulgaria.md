...
The `public contributions` by users in Bulgaria on `2024/11/12 8:37 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
