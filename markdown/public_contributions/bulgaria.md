...
The `public contributions` by users in Bulgaria on `2025/1/30 7:18 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
