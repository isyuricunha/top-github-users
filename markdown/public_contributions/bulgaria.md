...
The `public contributions` by users in Bulgaria on `2024/3/13 4:45 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
