...
The `public contributions` by users in Bulgaria on `2024/10/23 9:01 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
