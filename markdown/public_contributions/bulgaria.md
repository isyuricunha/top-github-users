...
The `public contributions` by users in Bulgaria on `2023/1/30 9:36 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
