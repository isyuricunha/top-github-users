...
The `public contributions` by users in Bulgaria on `2022/12/5 4:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
