...
The `public contributions` by users in Azerbaijan on `2022/12/6 9:32 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
