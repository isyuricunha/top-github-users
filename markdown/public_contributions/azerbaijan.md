...
The `public contributions` by users in Azerbaijan on `2023/2/19 8:32 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
