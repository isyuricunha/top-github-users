...
The `public contributions` by users in Azerbaijan on `2023/8/11 8:40 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
