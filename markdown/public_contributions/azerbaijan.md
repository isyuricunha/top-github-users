...
The `public contributions` by users in Azerbaijan on `2024/11/8 6:45 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
