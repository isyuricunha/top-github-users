...
The `public contributions` by users in Azerbaijan on `2024/4/12 1:19 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
