...
The `public contributions` by users in Azerbaijan on `2023/12/13 6:35 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
