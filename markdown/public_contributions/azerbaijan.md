...
The `public contributions` by users in Azerbaijan on `2022/12/23 12:59 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
