...
The `public contributions` by users in Azerbaijan on `2023/8/24 6:18 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
