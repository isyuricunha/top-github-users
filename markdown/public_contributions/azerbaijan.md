...
The `public contributions` by users in Azerbaijan on `2023/12/11 11:55 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
