...
The `public contributions` by users in Azerbaijan on `2023/2/23 2:34 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
