...
The `public contributions` by users in Azerbaijan on `2022/12/26 11:31 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
