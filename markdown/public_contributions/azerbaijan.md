...
The `public contributions` by users in Azerbaijan on `2022/10/31 9:01 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
