...
The `public contributions` by users in Azerbaijan on `2023/1/27 6:20 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
