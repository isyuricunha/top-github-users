...
The `public contributions` by users in Azerbaijan on `2023/3/21 6:47 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
