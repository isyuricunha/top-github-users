...
The `public contributions` by users in Azerbaijan on `2023/7/22 8:16 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
