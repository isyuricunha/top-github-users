...
The `public contributions` by users in New Zealand on `2023/4/1 7:15 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
