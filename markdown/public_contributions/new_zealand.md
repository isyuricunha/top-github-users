...
The `public contributions` by users in New Zealand on `2023/1/21 1:00 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
