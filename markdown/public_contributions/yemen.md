...
The `public contributions` by users in Yemen on `2022/12/17 10:54 PM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `939 users`  in Yemen. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/gafzanMo">
				<img src="https://avatars.githubusercontent.com/u/120124632?s=72&v=4" width="24" alt="Avatar of gafzanMo"> gafzanMo
			</a><br/>
			Mohammed Gafzan
		</td>
		<td>No Company</td>
