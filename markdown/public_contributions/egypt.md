...
The `public contributions` by users in Egypt on `2023/10/13 10:33 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
