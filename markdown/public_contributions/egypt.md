...
The `public contributions` by users in Egypt on `2023/10/30 11:27 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
