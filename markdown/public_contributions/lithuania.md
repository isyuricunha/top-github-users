...
The `public contributions` by users in Lithuania on `2022/12/18 8:35 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
