...
The `public contributions` by users in El Salvador on `2022/12/16 7:14 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
