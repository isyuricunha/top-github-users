...
The `public contributions` by users in Switzerland on `2023/10/31 11:43 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
