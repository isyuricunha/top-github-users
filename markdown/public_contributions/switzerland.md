...
The `public contributions` by users in Switzerland on `2023/6/21 6:37 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
