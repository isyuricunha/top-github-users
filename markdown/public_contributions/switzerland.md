...
The `public contributions` by users in Switzerland on `2024/8/2 11:58 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `882 users`  in Switzerland. You need at least `81 followers` to be on this list.
