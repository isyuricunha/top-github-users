...
The `public contributions` by users in Switzerland on `2023/10/13 5:56 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `905 users`  in Switzerland. You need at least `71 followers` to be on this list.
