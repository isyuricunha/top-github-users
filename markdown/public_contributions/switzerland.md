...
The `public contributions` by users in Switzerland on `2023/5/16 3:18 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
