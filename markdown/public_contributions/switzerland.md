...
The `public contributions` by users in Switzerland on `2023/1/10 3:01 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
