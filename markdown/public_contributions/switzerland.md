...
The `public contributions` by users in Switzerland on `2023/1/14 2:13 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
