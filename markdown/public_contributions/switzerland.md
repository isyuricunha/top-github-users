...
The `public contributions` by users in Switzerland on `2023/7/30 6:56 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
