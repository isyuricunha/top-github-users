...
The `public contributions` by users in Switzerland on `2024/8/22 5:37 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `879 users`  in Switzerland. You need at least `82 followers` to be on this list.
