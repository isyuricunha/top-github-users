...
The `public contributions` by users in Greece on `2025/9/24 12:48 AM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
...
<table>
	...
	<tr>
		<td>228</td>
		<td>
			<a href="https://github.com/chriskormaris">
				<img src="https://avatars.githubusercontent.com/u/4160597?s=72&u=27a21091758eec92a156a8476ff68cce79e273af&v=4" width="24" alt="Avatar of chriskormaris"> chriskormaris
			</a><br/>
			Christos Kormaris
		</td>
		<td>Deposit & Loan Fund<br/></td>
		<td>No Twitter Username</td>
		<td>Athens, Greece</td>
		<td>145</td>
	</tr>
