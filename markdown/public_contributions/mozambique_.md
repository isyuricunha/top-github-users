...
The `public contributions` by users in Mozambique  on `2023/5/1 11:30 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
