...
The `public contributions` by users in Nigeria on `2024/7/3 7:56 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/DPoeticManiac">DPoeticManiac</a></td>
		<td>Akure, Ondo, Nigeria</td>
		<td>78</td>
	</tr>
	<tr>
		<td>423</td>
