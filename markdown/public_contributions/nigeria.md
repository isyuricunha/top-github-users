...
The `public contributions` by users in Nigeria on `2025/1/15 11:36 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `993 users`  in Nigeria. You need at least `68 followers` to be on this list.
