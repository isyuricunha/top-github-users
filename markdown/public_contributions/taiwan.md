...
The `public contributions` by users in Taiwan on `2023/10/12 4:19 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
