...
The `public contributions` by users in Philippines on `2023/9/9 6:42 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>@myfursona-project And Fusky Labs<br/>E&m<br/></td>
		<td>No Twitter Username</td>
