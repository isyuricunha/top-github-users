...
The `public contributions` by users in Philippines on `2024/10/2 5:39 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>Manila, Philippines and Dhaka, Bangladesh</td>
		<td>6163</td>
	</tr>
	<tr>
		<td>13</td>
