...
The `public contributions` by users in Philippines on `2023/11/20 3:56 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jedt">
				<img src="https://avatars.githubusercontent.com/u/173964?s=72&v=4" width="24" alt="Avatar of jedt"> jedt
			</a><br/>
			jedt
		</td>
		<td>No Company</td>
