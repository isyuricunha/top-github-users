...
The `public contributions` by users in Philippines on `2024/9/28 4:57 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/festivities">
				<img src="https://avatars.githubusercontent.com/u/77230051?s=72&v=4" width="24" alt="Avatar of festivities"> festivities
			</a><br/>
			festivity
		</td>
		<td>De La Salle University<br/></td>
