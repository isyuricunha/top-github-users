...
The `public contributions` by users in Philippines on `2023/11/1 9:57 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/isaaacdev">isaaacdev</a></td>
		<td>Republic of the Philippines</td>
		<td>311</td>
	</tr>
	<tr>
