...
The `public contributions` by users in Philippines on `2023/8/1 5:56 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>130 J. Ramos St. Caloocan City, Philippines</td>
		<td>153</td>
	</tr>
	<tr>
		<td>275</td>
