...
The `public contributions` by users in Philippines on `2023/2/15 2:44 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
