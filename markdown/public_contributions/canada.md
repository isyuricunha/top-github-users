...
The `public contributions` by users in Canada on `2023/7/26 9:42 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		...
		<td>Huawei Canada Research Institutes<br/></td>
		<td>No Twitter Username</td>
