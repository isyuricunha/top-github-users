...
The `public contributions` by users in Canada on `2024/6/22 8:38 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `944 users`  in Canada. You need at least `202 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/lextm">
				<img src="https://avatars.githubusercontent.com/u/425130?s=72&u=7cde2a2da1a14e0a218d8687ed145e078c0af927&v=4" width="24" alt="Avatar of lextm"> lextm
			</a><br/>
			Lex Li
		</td>
		<td>@lextudio  </td>
