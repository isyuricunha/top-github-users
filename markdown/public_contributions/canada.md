...
The `public contributions` by users in Canada on `2023/9/5 12:26 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/isaackogan">
				<img src="https://avatars.githubusercontent.com/u/65869106?s=72&v=4" width="24" alt="Avatar of isaackogan"> isaackogan
			</a><br/>
			Isaac Kogan
		</td>
		<td>York University </td>
		<td><a href="https://twitter.com/isaacikogan">isaacikogan</a></td>
		<td>Ontario, Canada</td>
		<td>380</td>
	</tr>
	<tr>
