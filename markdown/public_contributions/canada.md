...
The `public contributions` by users in Canada on `2023/6/4 1:31 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `968 users`  in Canada. You need at least `173 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>352</td>
		<td>
			<a href="https://github.com/dalia3peterson">
				<img src="https://avatars.githubusercontent.com/u/132299401?s=72&u=557d56250754a1abc64ac64e6e586d0fe3ee7373&v=4" width="24" alt="Avatar of dalia3peterson"> dalia3peterson
			</a><br/>
			Baby Star
		</td>
		<td>No Company</td>
