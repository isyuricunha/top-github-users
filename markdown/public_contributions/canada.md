...
The `public contributions` by users in Canada on `2023/9/7 5:58 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		...
		<td>228 Chatham Ave, Toronto, ON M4J 1K9</td>
		<td>763</td>
	</tr>
	<tr>
		<td>160</td>
