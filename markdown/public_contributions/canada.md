...
The `public contributions` by users in Canada on `2024/7/19 9:36 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `943 users`  in Canada. You need at least `203 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ReallySnow">
				<img src="https://avatars.githubusercontent.com/u/31167977?s=72&u=610580882c468216ed8ff0e5ebdce7b39038e83a&v=4" width="24" alt="Avatar of ReallySnow"> ReallySnow
			</a><br/>
			なな
		</td>
		<td>No Company</td>
