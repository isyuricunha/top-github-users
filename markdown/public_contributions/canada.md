...
The `public contributions` by users in Canada on `2024/5/22 11:58 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `948 users`  in Canada. You need at least `199 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LouisLee-Dev">
				<img src="https://avatars.githubusercontent.com/u/132761249?s=72&u=65705e5fd852c3c3c77bc64c53e6eb833e107179&v=4" width="24" alt="Avatar of LouisLee-Dev"> LouisLee-Dev
			</a><br/>
			Louis Lee
		</td>
		<td>@anywhen-com  </td>
