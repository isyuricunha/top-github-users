...
The `public contributions` by users in Canada on `2023/11/24 10:18 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/lextm">
				<img src="https://avatars.githubusercontent.com/u/425130?s=72&u=3a3621e9d48e413dc2048f5e3f1abeda1490d2d4&v=4" width="24" alt="Avatar of lextm"> lextm
			</a><br/>
			Lex Li
		</td>
		<td>@lextudio  </td>
