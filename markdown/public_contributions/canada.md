...
The `public contributions` by users in Canada on `2024/3/13 5:57 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/tardishero">tardishero</a></td>
		<td>Ontario, Canada</td>
		<td>207</td>
	</tr>
	<tr>
