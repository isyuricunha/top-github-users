...
The `public contributions` by users in Canada on `2023/10/26 11:31 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		...
		<td>Oracle Ace, Türkiye Java<br/>User<br/>Group<br/>Leader<br/></td>
