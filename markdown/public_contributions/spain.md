...
The `public contributions` by users in Spain on `2022/12/17 6:00 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
