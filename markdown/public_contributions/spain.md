...
The `public contributions` by users in Spain on `2023/6/30 11:43 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
