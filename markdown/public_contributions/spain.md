...
The `public contributions` by users in Spain on `2023/12/23 2:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
