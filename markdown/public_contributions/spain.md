...
The `public contributions` by users in Spain on `2022/11/16 4:59 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
