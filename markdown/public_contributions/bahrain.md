...
The `public contributions` by users in Bahrain on `2023/7/29 1:15 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alishaamin">
				<img src="https://avatars.githubusercontent.com/u/125888571?s=72&v=4" width="24" alt="Avatar of alishaamin"> alishaamin
			</a><br/>
			Alisha Amin
		</td>
		<td>No Company</td>
