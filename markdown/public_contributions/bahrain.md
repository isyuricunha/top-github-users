...
The `public contributions` by users in Bahrain on `2023/12/23 10:54 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fadelyking">
				<img src="https://avatars.githubusercontent.com/u/128898609?s=72&v=4" width="24" alt="Avatar of fadelyking"> fadelyking
			</a><br/>
			Fadhel Alsaegh
		</td>
		<td>No Company</td>
