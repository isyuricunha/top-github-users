...
The `number of followers` of users in Palestine on `2024/1/17 9:41 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
