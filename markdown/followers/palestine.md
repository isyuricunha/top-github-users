...
The `number of followers` of users in Palestine on `2024/7/23 9:34 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
