...
The `number of followers` of users in Palestine on `2024/3/26 3:42 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
