...
The `number of followers` of users in Palestine on `2023/12/19 11:15 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
