...
The `number of followers` of users in Palestine on `2023/12/23 8:43 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
