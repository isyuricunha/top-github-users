...
The `number of followers` of users in Palestine on `2024/4/13 12:56 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
