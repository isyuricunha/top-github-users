...
The `number of followers` of users in Palestine on `2024/8/29 6:55 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
