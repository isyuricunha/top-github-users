...
The `number of followers` of users in Palestine on `2024/3/11 6:46 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
