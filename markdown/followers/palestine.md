...
The `number of followers` of users in Palestine on `2024/4/16 3:41 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
