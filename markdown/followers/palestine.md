...
The `number of followers` of users in Palestine on `2024/9/29 11:55 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
