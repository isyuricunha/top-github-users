...
The `number of followers` of users in Cameroon on `2025/1/5 1:37 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
