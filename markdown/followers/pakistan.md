...
The `number of followers` of users in Pakistan on `2024/5/16 9:31 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
