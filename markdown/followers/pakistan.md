...
The `number of followers` of users in Pakistan on `2024/2/13 2:42 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
