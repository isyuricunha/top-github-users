...
The `number of followers` of users in Pakistan on `2024/4/21 5:34 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
