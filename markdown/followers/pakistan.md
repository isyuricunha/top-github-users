...
The `number of followers` of users in Pakistan on `2023/12/13 3:32 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
