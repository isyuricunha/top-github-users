...
The `number of followers` of users in Pakistan on `2024/12/16 9:49 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
