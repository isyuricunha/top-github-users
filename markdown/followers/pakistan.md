...
The `number of followers` of users in Pakistan on `2025/2/11 3:39 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
