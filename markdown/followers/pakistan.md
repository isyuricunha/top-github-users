...
The `number of followers` of users in Pakistan on `2024/6/7 4:21 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
