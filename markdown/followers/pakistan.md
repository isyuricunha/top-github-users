...
The `number of followers` of users in Pakistan on `2023/9/22 10:32 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
