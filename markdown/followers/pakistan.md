...
The `number of followers` of users in Pakistan on `2023/7/22 6:18 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
