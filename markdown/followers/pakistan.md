...
The `number of followers` of users in Pakistan on `2023/11/12 2:46 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
