...
The `number of followers` of users in Pakistan on `2024/8/9 11:42 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
