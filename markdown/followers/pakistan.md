...
The `number of followers` of users in Pakistan on `2024/1/12 4:57 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
