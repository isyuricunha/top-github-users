...
The `number of followers` of users in Pakistan on `2023/11/17 6:21 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
