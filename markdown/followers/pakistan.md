...
The `number of followers` of users in Pakistan on `2024/3/2 5:30 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
