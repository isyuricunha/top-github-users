...
The `number of followers` of users in Pakistan on `2024/5/20 9:35 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
