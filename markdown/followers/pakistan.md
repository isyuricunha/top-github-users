...
The `number of followers` of users in Pakistan on `2023/6/24 1:01 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
