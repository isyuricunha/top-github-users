...
The `number of followers` of users in Pakistan on `2025/1/8 9:45 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
