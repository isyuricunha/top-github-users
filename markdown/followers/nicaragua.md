...
The `number of followers` of users in Nicaragua on `2024/6/1 4:45 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
