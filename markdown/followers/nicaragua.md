...
The `number of followers` of users in Nicaragua on `2024/11/20 8:24 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
