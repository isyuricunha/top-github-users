...
The `number of followers` of users in Nicaragua on `2023/11/17 4:56 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
