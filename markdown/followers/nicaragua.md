...
The `number of followers` of users in Nicaragua on `2024/3/19 10:34 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
