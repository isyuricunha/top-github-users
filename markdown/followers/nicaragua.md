...
The `number of followers` of users in Nicaragua on `2024/3/12 8:41 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
