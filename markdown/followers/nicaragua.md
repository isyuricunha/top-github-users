...
The `number of followers` of users in Nicaragua on `2024/8/18 2:17 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
