...
The `number of followers` of users in Nicaragua on `2025/2/7 10:56 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
