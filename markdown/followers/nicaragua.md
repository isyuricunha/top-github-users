...
The `number of followers` of users in Nicaragua on `2024/9/27 11:56 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
