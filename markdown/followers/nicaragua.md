...
The `number of followers` of users in Nicaragua on `2024/7/27 12:58 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
