...
The `number of followers` of users in Nicaragua on `2023/9/2 10:30 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
