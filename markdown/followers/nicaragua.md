...
The `number of followers` of users in Nicaragua on `2024/4/16 2:17 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
