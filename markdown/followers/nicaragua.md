...
The `number of followers` of users in Nicaragua on `2024/8/29 5:35 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
