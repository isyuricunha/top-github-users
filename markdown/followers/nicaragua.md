...
The `number of followers` of users in Nicaragua on `2024/11/13 9:56 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
