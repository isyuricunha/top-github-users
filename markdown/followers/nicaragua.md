...
The `number of followers` of users in Nicaragua on `2023/10/7 8:27 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
