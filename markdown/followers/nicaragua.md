...
The `number of followers` of users in Nicaragua on `2023/7/7 2:35 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
