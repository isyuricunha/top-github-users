...
The `number of followers` of users in Nicaragua on `2024/3/24 10:17 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
