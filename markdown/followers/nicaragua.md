...
The `number of followers` of users in Nicaragua on `2024/3/21 3:55 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
