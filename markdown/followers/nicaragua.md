...
The `number of followers` of users in Nicaragua on `2025/1/6 2:39 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
