...
The `number of followers` of users in Nicaragua on `2024/5/15 4:36 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
