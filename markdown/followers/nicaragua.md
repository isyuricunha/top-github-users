...
The `number of followers` of users in Nicaragua on `2024/11/1 6:23 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
