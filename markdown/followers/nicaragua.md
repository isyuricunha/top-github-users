...
The `number of followers` of users in Nicaragua on `2024/5/25 2:33 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
