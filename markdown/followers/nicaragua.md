...
The `number of followers` of users in Nicaragua on `2024/12/31 9:56 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
