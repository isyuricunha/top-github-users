...
The `number of followers` of users in Nicaragua on `2024/11/22 11:33 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
