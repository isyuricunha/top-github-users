...
The `number of followers` of users in Nicaragua on `2024/7/14 3:49 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
