...
The `number of followers` of users in Estonia on `2022/11/6 5:56 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
