...
The `number of followers` of users in Estonia on `2022/11/15 1:15 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
