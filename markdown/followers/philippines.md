...
The `number of followers` of users in Philippines on `2022/12/26 9:19 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
