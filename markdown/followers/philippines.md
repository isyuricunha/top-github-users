...
The `number of followers` of users in Philippines on `2023/1/13 6:21 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
