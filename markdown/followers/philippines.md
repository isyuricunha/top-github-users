...
The `number of followers` of users in Philippines on `2024/1/7 12:54 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
