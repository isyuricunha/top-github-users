...
The `number of followers` of users in Hong Kong on `2023/12/20 7:40 PM UTC`. This list contains users from `Hong Kong` and cities `Hong-kong` `Kowloon`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `942 users`  in Hong Kong. You need at least `28 followers` to be on this list.
