...
The `number of followers` of users in Iceland on `2024/11/28 6:26 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
...
<table>
	...
	<tr>
		<td>821</td>
		<td>
			<a href="https://github.com/AMT9S">
				<img src="https://avatars.githubusercontent.com/u/17859789?s=72&v=4" width="24" alt="Avatar of AMT9S"> AMT9S
			</a><br/>
			AMT_P
		</td>
		<td>No Company</td>
