...
The `number of followers` of users in Iceland on `2024/12/24 7:17 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
...
<table>
	...
	<tr>
		<td>867</td>
		<td>
			<a href="https://github.com/gugguson">
				<img src="https://avatars.githubusercontent.com/u/441428?s=72&v=4" width="24" alt="Avatar of gugguson"> gugguson
			</a><br/>
