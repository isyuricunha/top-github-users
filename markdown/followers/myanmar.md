...
The `number of followers` of users in Myanmar on `2023/6/12 5:32 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
