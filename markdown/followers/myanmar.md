...
The `number of followers` of users in Myanmar on `2023/4/18 1:20 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
