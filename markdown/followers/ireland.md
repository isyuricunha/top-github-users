...
The `number of followers` of users in Ireland on `2023/5/1 4:56 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
