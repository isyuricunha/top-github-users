...
The `number of followers` of users in Ireland on `2025/1/19 9:15 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
