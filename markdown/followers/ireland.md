...
The `number of followers` of users in Ireland on `2023/12/19 1:20 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
