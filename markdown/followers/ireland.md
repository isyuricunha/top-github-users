...
The `number of followers` of users in Ireland on `2022/12/5 4:49 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
