...
The `number of followers` of users in Ireland on `2023/2/16 9:42 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
