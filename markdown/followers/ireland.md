...
The `number of followers` of users in Ireland on `2023/12/16 3:42 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
