...
The `number of followers` of users in Finland on `2023/9/20 3:57 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
