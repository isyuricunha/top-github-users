...
The `number of followers` of users in Finland on `2023/12/3 6:57 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
