...
The `number of followers` of users in Finland on `2023/7/3 3:48 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
