...
The `number of followers` of users in Finland on `2024/11/23 7:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
