...
The `number of followers` of users in Finland on `2023/7/14 11:56 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
