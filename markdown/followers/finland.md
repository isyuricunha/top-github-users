...
The `number of followers` of users in Finland on `2023/1/27 4:59 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
