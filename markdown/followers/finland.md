...
The `number of followers` of users in Finland on `2024/11/15 9:40 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
