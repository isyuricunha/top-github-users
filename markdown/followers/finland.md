...
The `number of followers` of users in Finland on `2024/12/20 2:39 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
