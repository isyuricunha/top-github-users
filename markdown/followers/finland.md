...
The `number of followers` of users in Finland on `2024/1/24 8:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
