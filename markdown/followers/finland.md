...
The `number of followers` of users in Finland on `2024/4/1 5:57 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
