...
The `number of followers` of users in Finland on `2024/9/22 11:21 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
