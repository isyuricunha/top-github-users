...
The `number of followers` of users in Finland on `2023/5/16 8:31 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
