...
The `number of followers` of users in Finland on `2024/6/4 3:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
