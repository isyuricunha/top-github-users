...
The `number of followers` of users in Finland on `2024/1/30 9:30 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
