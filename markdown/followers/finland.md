...
The `number of followers` of users in Finland on `2022/11/21 8:22 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
