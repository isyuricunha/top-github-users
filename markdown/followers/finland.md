...
The `number of followers` of users in Finland on `2024/5/4 7:18 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
