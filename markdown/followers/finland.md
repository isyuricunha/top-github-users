...
The `number of followers` of users in Finland on `2022/11/29 7:00 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
