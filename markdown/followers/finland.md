...
The `number of followers` of users in Finland on `2023/7/18 2:55 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
