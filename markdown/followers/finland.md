...
The `number of followers` of users in Finland on `2023/11/14 8:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
