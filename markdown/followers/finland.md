...
The `number of followers` of users in Finland on `2024/12/9 5:02 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
