...
The `number of followers` of users in Finland on `2024/8/27 5:47 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
