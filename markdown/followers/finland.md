...
The `number of followers` of users in Finland on `2022/11/13 6:48 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
