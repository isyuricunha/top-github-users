...
The `number of followers` of users in Finland on `2024/12/20 2:50 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
