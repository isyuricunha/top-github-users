...
The `number of followers` of users in Finland on `2024/6/2 7:42 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
