...
The `number of followers` of users in Finland on `2022/12/23 10:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
