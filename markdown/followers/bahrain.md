...
The `number of followers` of users in Bahrain on `2024/10/14 11:18 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Hussain-Adel">
				<img src="https://avatars.githubusercontent.com/u/62424675?s=72&v=4" width="24" alt="Avatar of Hussain-Adel"> Hussain-Adel
			</a><br/>
			Hussain Adel
		</td>
		<td>No Company</td>
