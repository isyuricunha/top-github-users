...
The `number of followers` of users in South Korea on `2024/6/23 12:27 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>Gdsc(google Developer Student Clubs)<br/></td>
		<td>No Twitter Username</td>
		<td>Seoul</td>
		<td>396</td>
	</tr>
	...
	<tr>
		...
		<td>@team-cruze Leader  @stac-boundary<br/></td>
		<td>No Twitter Username</td>
		<td>Busan, Republic of Korea</td>
		<td>178</td>
	</tr>
