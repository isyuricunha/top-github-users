...
The `number of followers` of users in South Korea on `2023/7/20 6:46 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
