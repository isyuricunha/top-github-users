...
The `number of followers` of users in South Korea on `2024/8/13 10:22 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		<td>955</td>
		<td>
			<a href="https://github.com/hyeseung12">
	...
	<tr>
		<td>980</td>
		<td>
			<a href="https://github.com/chaentopia">
