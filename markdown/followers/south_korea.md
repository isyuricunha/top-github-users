...
The `number of followers` of users in South Korea on `2023/12/13 8:48 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>Viva Republica(@toss), @woowacourse </td>
		<td>No Twitter Username</td>
