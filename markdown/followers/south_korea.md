...
The `number of followers` of users in South Korea on `2022/11/20 7:23 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
