...
The `number of followers` of users in South Korea on `2024/7/9 11:57 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		<td>765</td>
		<td>
			<a href="https://github.com/kevinprk">
