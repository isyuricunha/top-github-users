...
The `number of followers` of users in South Korea on `2024/12/25 5:48 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@sw-maestro-oss @boostcampwm-2022 @likelion-yeungnam-u </td>
		<td>No Twitter Username</td>
