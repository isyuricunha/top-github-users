...
The `number of followers` of users in South Korea on `2023/12/15 3:43 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@vmware-tanzu </td>
		<td>No Twitter Username</td>
		<td>Tanzu Labs, VMWare, Asem Tower, Samsung, Seoul</td>
		<td>113</td>
	</tr>
	<tr>
		<td>615</td>
