...
The `number of followers` of users in Taiwan on `2023/10/10 11:17 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
