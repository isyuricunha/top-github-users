...
The `number of followers` of users in Taiwan on `2023/11/12 10:33 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
