...
The `number of followers` of users in Taiwan on `2022/11/12 10:42 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
