...
The `number of followers` of users in Taiwan on `2022/11/17 11:03 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
