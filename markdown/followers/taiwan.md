...
The `number of followers` of users in Taiwan on `2023/11/28 10:39 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
