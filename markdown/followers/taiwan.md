...
The `number of followers` of users in Taiwan on `2023/6/23 3:35 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `987 users`  in Taiwan. You need at least `48 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>784</td>
		<td>
			<a href="https://github.com/Jrzlin">
				<img src="https://avatars.githubusercontent.com/u/6073778?s=72&v=4" width="24" alt="Avatar of Jrzlin"> Jrzlin
			</a><br/>
			Lin.cc
		</td>
		<td>No Company</td>
