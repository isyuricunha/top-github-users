...
The `number of followers` of users in Taiwan on `2024/1/11 9:30 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `974 users`  in Taiwan. You need at least `52 followers` to be on this list.
