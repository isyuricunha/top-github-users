...
The `number of followers` of users in Taiwan on `2022/12/10 10:36 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
