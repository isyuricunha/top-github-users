...
The `number of followers` of users in Croatia on `2024/12/24 11:58 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
