...
The `number of followers` of users in Croatia on `2025/4/29 2:28 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
