...
The `number of followers` of users in Croatia on `2023/10/20 10:44 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
