...
The `number of followers` of users in Croatia on `2023/10/30 9:31 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
