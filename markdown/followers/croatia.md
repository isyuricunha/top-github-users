...
The `number of followers` of users in Croatia on `2023/12/15 7:27 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
