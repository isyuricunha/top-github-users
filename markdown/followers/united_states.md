...
The `number of followers` of users in United States on `2024/5/12 4:21 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
