...
The `number of followers` of users in United States on `2024/9/30 2:25 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
