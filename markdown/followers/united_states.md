...
The `number of followers` of users in United States on `2024/2/25 1:43 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
