...
The `number of followers` of users in United States on `2024/6/3 10:21 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
