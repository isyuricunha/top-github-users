...
The `number of followers` of users in United States on `2023/4/27 2:57 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
