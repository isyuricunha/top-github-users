...
The `number of followers` of users in Moldova on `2024/7/27 9:41 AM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/softwindID">
				<img src="https://avatars.githubusercontent.com/u/166948585?s=72&v=4" width="24" alt="Avatar of softwindID"> softwindID
			</a><br/>
			Irina Dobrenco
		</td>
		<td>No Company</td>
