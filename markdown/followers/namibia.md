...
The `number of followers` of users in Namibia on `2023/9/26 4:31 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
