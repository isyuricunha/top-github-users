...
The `number of followers` of users in Namibia on `2023/11/25 4:16 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
