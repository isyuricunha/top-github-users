...
The `number of followers` of users in Namibia on `2023/4/27 2:43 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
