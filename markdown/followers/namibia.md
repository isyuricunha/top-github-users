...
The `number of followers` of users in Namibia on `2024/5/3 2:28 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
