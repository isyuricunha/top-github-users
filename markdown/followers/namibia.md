...
The `number of followers` of users in Namibia on `2023/4/18 1:32 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
