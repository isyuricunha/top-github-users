...
The `number of followers` of users in Namibia on `2023/8/28 9:12 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
