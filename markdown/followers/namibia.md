...
The `number of followers` of users in Namibia on `2023/2/11 4:38 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
