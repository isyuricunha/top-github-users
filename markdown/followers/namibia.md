...
The `number of followers` of users in Namibia on `2023/11/29 4:42 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
