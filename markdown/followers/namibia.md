...
The `number of followers` of users in Namibia on `2023/1/11 1:26 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
