...
The `number of followers` of users in Namibia on `2024/12/25 8:41 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
