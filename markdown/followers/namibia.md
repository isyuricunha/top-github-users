...
The `number of followers` of users in Namibia on `2022/12/26 5:37 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
