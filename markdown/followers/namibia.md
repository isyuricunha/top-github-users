...
The `number of followers` of users in Namibia on `2024/1/10 8:15 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
