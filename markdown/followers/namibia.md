...
The `number of followers` of users in Namibia on `2023/4/20 6:43 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
