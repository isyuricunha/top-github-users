...
The `number of followers` of users in Namibia on `2023/1/20 11:29 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
