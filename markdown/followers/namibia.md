...
The `number of followers` of users in Namibia on `2023/3/7 5:40 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
