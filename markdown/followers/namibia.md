...
The `number of followers` of users in Namibia on `2023/4/15 5:28 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
