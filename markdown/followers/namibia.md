...
The `number of followers` of users in Namibia on `2023/12/23 6:16 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
