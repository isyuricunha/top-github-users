...
The `number of followers` of users in Namibia on `2022/11/16 5:52 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
