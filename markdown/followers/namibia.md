...
The `number of followers` of users in Namibia on `2023/5/24 2:45 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
