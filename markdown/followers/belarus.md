...
The `number of followers` of users in Belarus on `2023/12/1 5:33 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
