...
The `number of followers` of users in Belarus on `2022/12/3 6:20 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
