...
The `number of followers` of users in Belarus on `2023/1/30 7:28 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
