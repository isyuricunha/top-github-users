...
The `number of followers` of users in Belarus on `2024/10/12 11:18 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
