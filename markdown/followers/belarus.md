...
The `number of followers` of users in Belarus on `2024/11/25 10:45 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
