...
The `number of followers` of users in Belarus on `2023/1/21 7:14 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
