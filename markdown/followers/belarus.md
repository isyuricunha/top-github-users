...
The `number of followers` of users in Belarus on `2023/12/23 11:28 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
