...
The `number of followers` of users in Belarus on `2023/12/22 8:43 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
