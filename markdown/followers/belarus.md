...
The `number of followers` of users in Belarus on `2022/12/27 12:57 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
