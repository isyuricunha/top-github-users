...
The `number of followers` of users in Belarus on `2022/12/21 5:00 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
