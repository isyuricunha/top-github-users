...
The `number of followers` of users in China on `2023/8/29 9:16 PM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `967 users`  in China. You need at least `678 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@rosedblabs @servicemesher @b3log </td>
