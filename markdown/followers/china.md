...
The `number of followers` of users in China on `2023/6/29 7:18 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/egoist">
				<img src="https://avatars.githubusercontent.com/u/8784712?s=72&u=dea234544702652314916025a220fb0d8f85e4be&v=4" width="24" alt="Avatar of egoist"> egoist
			</a><br/>
			EGOIST
		</td>
		<td>Umida Inc. </td>
	...
	<tr>
		...
		<td>@bocloud @rosedblabs @servicemesher @b3log<br/></td>
	...
	<tr>
		...
		<td>@didi, And Available For<br/>A<br/>New<br/>Work<br/>:)<br/></td>
	...
	<tr>
		...
		<td>Bs@csu, Master@ucas, Phd@sjtu, Researcher@pjlab<br/></td>
		<td>No Twitter Username</td>
		<td>Shanghai</td>
		<td>959</td>
	</tr>
	...
	<tr>
		...
		<td>Day @05sec / Night<br/>@7ie<br/></td>
	...
	<tr>
		...
		<td>Day @qiniu / Night<br/>@gentoo<br/></td>
		<td>No Twitter Username</td>
		<td>Shanghai</td>
		<td>674</td>
	</tr>
