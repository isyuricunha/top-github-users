...
The `number of followers` of users in Peru on `2023/11/3 3:17 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
...
<table>
	...
	<tr>
		<td>840</td>
		<td>
			<a href="https://github.com/gcanahuirev">
				<img src="https://avatars.githubusercontent.com/u/42349458?s=72&v=4" width="24" alt="Avatar of gcanahuirev"> gcanahuirev
			</a><br/>
			Giuseppe
		</td>
		<td>No Company</td>
