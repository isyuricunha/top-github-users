...
The `number of followers` of users in Peru on `2024/3/2 6:33 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
