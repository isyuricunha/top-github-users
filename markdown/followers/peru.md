...
The `number of followers` of users in Peru on `2024/11/11 10:47 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/andleo17">andleo17</a></td>
		<td>Chiclayo, Perú</td>
		<td>7</td>
	</tr>
	<tr>
