...
The `number of followers` of users in Peru on `2023/12/23 9:28 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
