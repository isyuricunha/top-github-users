...
The `number of followers` of users in Peru on `2024/5/30 11:42 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
...
<table>
	...
	<tr>
		...
		<td>@avatar-global </td>
		<td><a href="https://twitter.com/CabosManuel">CabosManuel</a></td>
		<td>Lima, Peru</td>
		<td>7</td>
	</tr>
	<tr>
