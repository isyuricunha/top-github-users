...
The `number of followers` of users in Peru on `2023/8/19 8:30 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
