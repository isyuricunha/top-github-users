...
The `number of followers` of users in Peru on `2023/10/16 6:47 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `970 users`  in Peru. You need at least `6 followers` to be on this list.
