...
The `number of followers` of users in Azerbaijan on `2023/6/12 11:28 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
