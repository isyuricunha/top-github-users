...
The `number of followers` of users in Azerbaijan on `2024/11/2 2:45 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
