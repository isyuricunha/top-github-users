...
The `number of followers` of users in Azerbaijan on `2023/8/23 4:33 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
