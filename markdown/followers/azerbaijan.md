...
The `number of followers` of users in Azerbaijan on `2023/7/29 1:01 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
