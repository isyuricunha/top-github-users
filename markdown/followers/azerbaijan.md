...
The `number of followers` of users in Azerbaijan on `2024/4/23 1:18 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
