...
The `number of followers` of users in Azerbaijan on `2022/12/16 9:17 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
