...
The `number of followers` of users in Azerbaijan on `2024/2/4 9:16 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
