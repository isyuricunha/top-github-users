...
The `number of followers` of users in Azerbaijan on `2024/6/20 8:38 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
