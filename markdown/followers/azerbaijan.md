...
The `number of followers` of users in Azerbaijan on `2023/11/12 5:15 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
