...
The `number of followers` of users in Azerbaijan on `2024/5/7 6:39 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
