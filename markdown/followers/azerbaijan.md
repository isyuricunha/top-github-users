...
The `number of followers` of users in Azerbaijan on `2023/12/3 9:28 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
