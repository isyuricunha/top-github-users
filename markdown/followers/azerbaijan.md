...
The `number of followers` of users in Azerbaijan on `2024/4/7 12:22 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
