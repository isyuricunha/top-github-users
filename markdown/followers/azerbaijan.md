...
The `number of followers` of users in Azerbaijan on `2023/4/22 4:18 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
