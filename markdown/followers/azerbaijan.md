...
The `number of followers` of users in Azerbaijan on `2022/11/14 11:19 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
