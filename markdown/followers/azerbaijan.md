...
The `number of followers` of users in Azerbaijan on `2023/5/13 3:41 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
