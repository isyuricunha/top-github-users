...
The `number of followers` of users in Ecuador on `2024/5/12 5:30 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
