...
The `number of followers` of users in Ecuador on `2024/4/28 11:41 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
