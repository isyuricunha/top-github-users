...
The `number of followers` of users in Ecuador on `2023/11/6 6:37 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
