...
The `number of followers` of users in Ecuador on `2023/7/24 7:55 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
