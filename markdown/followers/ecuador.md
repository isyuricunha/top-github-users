...
The `number of followers` of users in Ecuador on `2023/9/5 5:07 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
