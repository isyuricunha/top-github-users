...
The `number of followers` of users in Ecuador on `2023/12/22 4:19 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
