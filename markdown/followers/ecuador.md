...
The `number of followers` of users in Ecuador on `2023/1/8 10:33 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
