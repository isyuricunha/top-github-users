...
The `number of followers` of users in Ecuador on `2023/1/25 6:36 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
