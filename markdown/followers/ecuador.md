...
The `number of followers` of users in Ecuador on `2024/3/20 12:23 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
