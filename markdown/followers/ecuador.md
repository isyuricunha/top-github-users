...
The `number of followers` of users in Ecuador on `2024/4/20 1:02 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
