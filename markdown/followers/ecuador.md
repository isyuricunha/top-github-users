...
The `number of followers` of users in Ecuador on `2022/11/29 5:18 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
