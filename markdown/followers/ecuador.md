...
The `number of followers` of users in Ecuador on `2024/9/13 8:22 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
