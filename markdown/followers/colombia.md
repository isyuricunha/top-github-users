...
The `number of followers` of users in Colombia on `2024/11/2 9:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
