...
The `number of followers` of users in Colombia on `2024/9/16 11:43 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
