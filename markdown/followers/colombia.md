...
The `number of followers` of users in Colombia on `2024/6/29 12:56 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
