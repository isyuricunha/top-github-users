...
The `number of followers` of users in Colombia on `2025/1/21 6:26 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
