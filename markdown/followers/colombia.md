...
The `number of followers` of users in Colombia on `2024/5/23 3:34 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
