...
The `number of followers` of users in Colombia on `2024/4/15 8:57 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
