...
The `number of followers` of users in Colombia on `2024/8/1 7:31 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
