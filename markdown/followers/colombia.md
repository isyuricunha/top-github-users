...
The `number of followers` of users in Colombia on `2023/4/16 5:41 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
