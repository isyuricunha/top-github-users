...
The `number of followers` of users in Colombia on `2024/12/13 5:21 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
