...
The `number of followers` of users in Colombia on `2023/9/13 8:41 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
