...
The `number of followers` of users in Colombia on `2024/8/19 2:49 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
...
<table>
	...
	<tr>
		...
		<td>Anna.money </td>
		<td>No Twitter Username</td>
		<td>Santa Cruz de Mompox, Colombia</td>
		<td>204</td>
	</tr>
	<tr>
		<td>67</td>
