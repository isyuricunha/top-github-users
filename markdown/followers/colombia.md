...
The `number of followers` of users in Colombia on `2023/12/15 6:56 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
