...
The `number of followers` of users in Colombia on `2024/5/24 8:42 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
