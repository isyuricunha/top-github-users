...
The `number of followers` of users in Colombia on `2023/12/1 10:34 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
