...
The `number of followers` of users in Colombia on `2024/3/13 7:41 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
