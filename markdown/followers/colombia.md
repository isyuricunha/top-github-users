...
The `number of followers` of users in Colombia on `2025/1/3 4:58 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
