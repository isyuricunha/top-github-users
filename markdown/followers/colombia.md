...
The `number of followers` of users in Colombia on `2024/9/11 7:43 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
