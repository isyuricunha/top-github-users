...
The `number of followers` of users in Colombia on `2024/10/17 10:21 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
