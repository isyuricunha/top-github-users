...
The `number of followers` of users in Colombia on `2024/7/8 10:20 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
