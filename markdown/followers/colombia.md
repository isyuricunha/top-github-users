...
The `number of followers` of users in Colombia on `2024/4/22 3:19 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
