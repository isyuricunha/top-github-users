...
The `number of followers` of users in Colombia on `2024/6/25 10:18 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
