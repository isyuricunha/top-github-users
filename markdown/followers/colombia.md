...
The `number of followers` of users in Colombia on `2024/8/25 4:56 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
