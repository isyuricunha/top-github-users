...
The `number of followers` of users in Colombia on `2024/9/7 10:56 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
