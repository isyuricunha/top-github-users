...
The `number of followers` of users in Colombia on `2023/10/3 6:36 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
