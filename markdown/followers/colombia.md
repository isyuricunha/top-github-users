...
The `number of followers` of users in Colombia on `2024/2/11 4:55 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
