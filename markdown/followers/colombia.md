...
The `number of followers` of users in Colombia on `2023/2/9 4:39 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
