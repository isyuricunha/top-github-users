...
The `number of followers` of users in Colombia on `2022/11/17 11:19 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
