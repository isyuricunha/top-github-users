...
The `number of followers` of users in Colombia on `2023/3/26 2:30 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
