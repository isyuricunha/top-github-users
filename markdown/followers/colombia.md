...
The `number of followers` of users in Colombia on `2022/12/21 9:58 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
