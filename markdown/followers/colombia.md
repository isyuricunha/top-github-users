...
The `number of followers` of users in Colombia on `2022/12/3 11:43 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
