...
The `number of followers` of users in Colombia on `2024/7/28 1:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
