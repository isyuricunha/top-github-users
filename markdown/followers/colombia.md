...
The `number of followers` of users in Colombia on `2024/7/3 2:37 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
