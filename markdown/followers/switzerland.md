...
The `number of followers` of users in Switzerland on `2025/2/3 11:45 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
