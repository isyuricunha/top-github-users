...
The `number of followers` of users in Switzerland on `2024/3/26 9:57 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
