...
The `number of followers` of users in Switzerland on `2022/12/21 8:17 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
