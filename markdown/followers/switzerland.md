...
The `number of followers` of users in Switzerland on `2022/11/8 11:33 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
