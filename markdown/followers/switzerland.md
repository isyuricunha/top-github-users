...
The `number of followers` of users in Switzerland on `2024/12/21 5:37 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
