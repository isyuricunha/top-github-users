...
The `number of followers` of users in Switzerland on `2023/11/24 9:57 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
