...
The `number of followers` of users in Switzerland on `2024/6/5 3:58 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
