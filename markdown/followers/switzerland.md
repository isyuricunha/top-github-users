...
The `number of followers` of users in Switzerland on `2024/4/26 3:42 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
