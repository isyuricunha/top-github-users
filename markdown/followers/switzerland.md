...
The `number of followers` of users in Switzerland on `2022/12/23 4:27 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
