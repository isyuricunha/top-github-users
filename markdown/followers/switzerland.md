...
The `number of followers` of users in Switzerland on `2024/10/28 9:20 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
