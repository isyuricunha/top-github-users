...
The `number of followers` of users in Switzerland on `2023/2/17 6:21 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
