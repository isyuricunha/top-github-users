...
The `number of followers` of users in Switzerland on `2025/10/30 12:52 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
