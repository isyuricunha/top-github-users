...
The `number of followers` of users in Switzerland on `2023/12/15 4:57 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
