...
The `number of followers` of users in Switzerland on `2024/5/8 1:57 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
