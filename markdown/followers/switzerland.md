...
The `number of followers` of users in Switzerland on `2024/2/17 5:16 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
