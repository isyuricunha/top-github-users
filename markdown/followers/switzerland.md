...
The `number of followers` of users in Switzerland on `2024/5/29 12:28 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
