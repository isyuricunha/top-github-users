...
The `number of followers` of users in Switzerland on `2024/4/13 7:26 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
