...
The `number of followers` of users in Switzerland on `2022/11/23 12:58 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
