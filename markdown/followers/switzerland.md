...
The `number of followers` of users in Switzerland on `2023/7/22 1:31 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
