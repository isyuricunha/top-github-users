...
The `number of followers` of users in Switzerland on `2022/12/6 1:43 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
