...
The `number of followers` of users in Switzerland on `2024/11/20 7:20 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
