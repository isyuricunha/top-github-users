...
The `number of followers` of users in Switzerland on `2024/6/12 8:57 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
