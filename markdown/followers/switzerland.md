...
The `number of followers` of users in Switzerland on `2023/1/6 10:42 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
