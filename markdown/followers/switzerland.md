...
The `number of followers` of users in Switzerland on `2024/7/7 6:38 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
