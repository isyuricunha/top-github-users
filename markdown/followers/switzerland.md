...
The `number of followers` of users in Switzerland on `2022/11/14 12:32 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
