...
The `number of followers` of users in Switzerland on `2023/2/8 11:57 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
