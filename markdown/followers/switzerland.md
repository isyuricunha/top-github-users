...
The `number of followers` of users in Switzerland on `2024/8/30 4:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
