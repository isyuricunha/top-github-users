...
The `number of followers` of users in Switzerland on `2023/6/24 8:34 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
