...
The `number of followers` of users in Switzerland on `2023/7/27 1:38 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
