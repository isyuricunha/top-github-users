...
The `number of followers` of users in Switzerland on `2022/12/19 12:22 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
