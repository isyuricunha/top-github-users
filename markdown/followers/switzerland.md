...
The `number of followers` of users in Switzerland on `2024/7/2 10:39 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
