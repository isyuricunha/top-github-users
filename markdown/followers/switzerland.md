...
The `number of followers` of users in Switzerland on `2023/10/9 8:57 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
