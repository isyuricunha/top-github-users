...
The `number of followers` of users in Switzerland on `2023/4/29 4:56 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
