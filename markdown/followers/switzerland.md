...
The `number of followers` of users in Switzerland on `2023/3/31 1:00 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
