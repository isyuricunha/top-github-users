...
The `number of followers` of users in Switzerland on `2024/9/12 1:47 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
