...
The `number of followers` of users in Switzerland on `2024/6/7 11:43 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
