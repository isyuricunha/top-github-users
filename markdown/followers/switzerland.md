...
The `number of followers` of users in Switzerland on `2023/2/28 5:45 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
