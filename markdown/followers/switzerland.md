...
The `number of followers` of users in Switzerland on `2023/8/26 2:56 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
