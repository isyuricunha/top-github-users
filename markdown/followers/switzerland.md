...
The `number of followers` of users in Switzerland on `2023/9/8 9:42 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
