...
The `number of followers` of users in Switzerland on `2024/3/19 7:42 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
