...
The `number of followers` of users in Switzerland on `2023/12/28 4:39 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
