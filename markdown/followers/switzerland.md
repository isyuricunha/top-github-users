...
The `number of followers` of users in Switzerland on `2024/12/3 3:59 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
