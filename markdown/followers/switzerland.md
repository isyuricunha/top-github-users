...
The `number of followers` of users in Switzerland on `2024/6/2 2:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
