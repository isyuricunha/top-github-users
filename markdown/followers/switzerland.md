...
The `number of followers` of users in Switzerland on `2025/2/9 8:58 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
