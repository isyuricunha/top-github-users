...
The `number of followers` of users in Switzerland on `2023/10/4 8:43 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
