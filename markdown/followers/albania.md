...
The `number of followers` of users in Albania on `2023/9/21 8:28 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/joankabello">
				<img src="https://avatars.githubusercontent.com/u/38832279?s=72&v=4" width="24" alt="Avatar of joankabello"> joankabello
			</a><br/>
			Joan Kabello
		</td>
		<td>No Company</td>
