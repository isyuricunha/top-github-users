...
The `number of followers` of users in Albania on `2024/6/13 4:26 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `1655 users`  in Albania. You need at least `1 followers` to be on this list.
