...
The `number of followers` of users in United Arab Emirates on `2024/8/2 2:48 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
