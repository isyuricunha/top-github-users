...
The `number of followers` of users in United Arab Emirates on `2025/4/2 12:38 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
