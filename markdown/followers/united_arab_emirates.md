...
The `number of followers` of users in United Arab Emirates on `2022/11/23 5:26 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
