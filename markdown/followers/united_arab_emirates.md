...
The `number of followers` of users in United Arab Emirates on `2023/8/8 5:48 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
