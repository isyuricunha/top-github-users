...
The `number of followers` of users in United Arab Emirates on `2023/10/26 2:26 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
