...
The `number of followers` of users in Bulgaria on `2023/12/3 12:54 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
