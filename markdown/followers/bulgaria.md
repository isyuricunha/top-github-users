...
The `number of followers` of users in Bulgaria on `2024/4/5 11:18 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
