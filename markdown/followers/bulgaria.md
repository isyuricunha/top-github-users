...
The `number of followers` of users in Bulgaria on `2024/11/21 9:01 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
