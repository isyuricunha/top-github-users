...
The `number of followers` of users in Bulgaria on `2024/1/28 11:17 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
