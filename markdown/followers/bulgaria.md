...
The `number of followers` of users in Bulgaria on `2023/7/8 11:56 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
