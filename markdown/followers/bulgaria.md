...
The `number of followers` of users in Bulgaria on `2024/10/27 10:21 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
