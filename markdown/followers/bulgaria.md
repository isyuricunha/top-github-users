...
The `number of followers` of users in Bulgaria on `2024/3/30 7:28 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
