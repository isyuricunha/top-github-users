...
The `number of followers` of users in Bulgaria on `2023/2/25 12:59 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
