...
The `number of followers` of users in Bulgaria on `2025/2/12 3:39 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
