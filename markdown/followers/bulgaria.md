...
The `number of followers` of users in Bulgaria on `2024/6/23 11:42 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
