...
The `number of followers` of users in Bulgaria on `2024/12/20 6:52 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
