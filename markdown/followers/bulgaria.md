...
The `number of followers` of users in Bulgaria on `2024/6/7 10:44 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
