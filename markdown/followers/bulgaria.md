...
The `number of followers` of users in Bulgaria on `2025/9/9 2:22 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
