...
The `number of followers` of users in Bulgaria on `2024/1/25 6:57 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
