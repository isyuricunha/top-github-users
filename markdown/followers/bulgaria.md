...
The `number of followers` of users in Bulgaria on `2024/8/8 10:49 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
