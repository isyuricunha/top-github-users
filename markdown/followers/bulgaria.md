...
The `number of followers` of users in Bulgaria on `2024/9/11 3:48 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
