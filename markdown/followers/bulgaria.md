...
The `number of followers` of users in Bulgaria on `2024/5/14 5:35 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
