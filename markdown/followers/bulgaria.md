...
The `number of followers` of users in Bulgaria on `2024/7/10 2:59 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
