...
The `number of followers` of users in Bulgaria on `2023/11/30 3:18 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
