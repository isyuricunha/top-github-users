...
The `number of followers` of users in Bulgaria on `2024/2/4 11:55 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
