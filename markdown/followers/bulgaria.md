...
The `number of followers` of users in Bulgaria on `2023/10/31 10:33 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
