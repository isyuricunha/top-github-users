...
The `number of followers` of users in Bulgaria on `2024/8/19 11:18 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
