...
The `number of followers` of users in Bulgaria on `2024/7/17 9:46 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
