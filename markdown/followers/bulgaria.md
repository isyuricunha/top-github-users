...
The `number of followers` of users in Bulgaria on `2024/6/20 11:29 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
