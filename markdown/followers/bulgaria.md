...
The `number of followers` of users in Bulgaria on `2024/7/22 9:43 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
