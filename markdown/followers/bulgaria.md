...
The `number of followers` of users in Bulgaria on `2024/12/24 7:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
