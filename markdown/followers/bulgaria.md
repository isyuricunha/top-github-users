...
The `number of followers` of users in Bulgaria on `2022/11/9 3:59 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
