...
The `number of followers` of users in Bulgaria on `2024/4/16 8:56 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
