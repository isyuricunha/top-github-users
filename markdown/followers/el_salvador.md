...
The `number of followers` of users in El Salvador on `2023/1/29 9:29 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
