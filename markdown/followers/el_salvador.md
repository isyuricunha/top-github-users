...
The `number of followers` of users in El Salvador on `2023/8/15 10:15 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
