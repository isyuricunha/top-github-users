...
The `number of followers` of users in Jordan on `2024/6/4 9:30 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
