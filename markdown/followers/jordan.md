...
The `number of followers` of users in Jordan on `2024/6/17 10:40 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `1077 users`  in Jordan. You need at least `6 followers` to be on this list.
