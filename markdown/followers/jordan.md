...
The `number of followers` of users in Jordan on `2024/10/23 10:39 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
