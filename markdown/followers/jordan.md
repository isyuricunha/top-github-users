...
The `number of followers` of users in Jordan on `2023/7/3 9:32 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
