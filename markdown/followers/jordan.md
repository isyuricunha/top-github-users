...
The `number of followers` of users in Jordan on `2024/8/25 2:33 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
