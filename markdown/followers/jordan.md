...
The `number of followers` of users in Jordan on `2024/5/7 9:40 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
