...
The `number of followers` of users in Jordan on `2024/12/20 9:42 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
