...
The `number of followers` of users in Jordan on `2024/11/26 6:25 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
