...
The `number of followers` of users in Jordan on `2024/11/24 4:42 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
