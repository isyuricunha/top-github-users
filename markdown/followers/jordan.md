...
The `number of followers` of users in Jordan on `2024/1/7 2:51 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
