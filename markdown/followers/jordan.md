...
The `number of followers` of users in Jordan on `2024/5/2 6:56 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
