...
The `number of followers` of users in Jordan on `2023/12/16 4:55 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
