...
The `number of followers` of users in Jordan on `2025/1/2 3:23 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
