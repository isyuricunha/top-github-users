...
The `number of followers` of users in Jordan on `2024/5/1 2:32 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
