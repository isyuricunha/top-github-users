...
The `number of followers` of users in Jordan on `2024/9/2 3:57 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
