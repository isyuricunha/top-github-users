...
The `number of followers` of users in Jordan on `2024/12/5 1:10 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
