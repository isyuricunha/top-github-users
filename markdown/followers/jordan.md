...
The `number of followers` of users in Jordan on `2024/12/18 5:38 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
