...
The `number of followers` of users in Jordan on `2025/1/19 10:37 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
