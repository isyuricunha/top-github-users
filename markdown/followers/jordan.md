...
The `number of followers` of users in Jordan on `2024/9/7 8:55 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
...
<table>
	...
	<tr>
		...
		<td>Leasifier, Ex-atypon, Ex-wiley, Stealth<br/>Startup,<br/></td>
		<td>No Twitter Username</td>
		<td>Amman - Jordan</td>
		<td>13</td>
	</tr>
