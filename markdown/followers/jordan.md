...
The `number of followers` of users in Jordan on `2024/9/13 4:20 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
