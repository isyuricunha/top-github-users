...
The `number of followers` of users in Spain on `2023/3/20 8:57 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
