...
The `number of followers` of users in Spain on `2023/1/4 12:23 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
