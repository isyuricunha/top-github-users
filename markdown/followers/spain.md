...
The `number of followers` of users in Spain on `2023/12/30 6:57 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
