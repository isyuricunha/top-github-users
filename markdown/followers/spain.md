...
The `number of followers` of users in Spain on `2023/4/18 9:31 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
