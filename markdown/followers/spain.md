...
The `number of followers` of users in Spain on `2023/9/6 3:58 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
