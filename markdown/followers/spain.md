...
The `number of followers` of users in Spain on `2024/6/3 6:42 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
