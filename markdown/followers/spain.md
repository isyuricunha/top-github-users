...
The `number of followers` of users in Spain on `2023/11/5 1:04 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
