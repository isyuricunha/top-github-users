...
The `number of followers` of users in Spain on `2022/12/10 7:53 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
