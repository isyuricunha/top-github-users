...
The `number of followers` of users in Spain on `2023/10/23 2:38 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
