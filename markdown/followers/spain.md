...
The `number of followers` of users in Spain on `2024/6/12 7:43 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
