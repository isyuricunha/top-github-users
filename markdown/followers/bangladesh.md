...
The `number of followers` of users in Bangladesh on `2024/8/28 3:56 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			MD MAHADE HASAN - (MAHADI HASAN AFRIDI)
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
