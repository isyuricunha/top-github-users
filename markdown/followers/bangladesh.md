...
The `number of followers` of users in Bangladesh on `2023/2/12 12:24 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
