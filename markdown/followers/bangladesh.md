...
The `number of followers` of users in Bangladesh on `2022/12/14 1:28 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
