...
The `number of followers` of users in Burundi on `2024/7/2 10:30 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
