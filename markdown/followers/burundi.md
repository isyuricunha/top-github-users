...
The `number of followers` of users in Burundi on `2023/2/8 11:35 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
