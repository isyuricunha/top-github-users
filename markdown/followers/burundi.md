...
The `number of followers` of users in Burundi on `2024/12/28 10:14 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
