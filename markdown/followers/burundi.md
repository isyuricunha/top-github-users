...
The `number of followers` of users in Burundi on `2022/12/3 9:11 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
