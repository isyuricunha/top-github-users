...
The `number of followers` of users in Burundi on `2025/2/6 9:41 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
