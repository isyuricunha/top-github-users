...
The `number of followers` of users in Burundi on `2024/1/24 1:48 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
