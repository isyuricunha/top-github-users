...
The `number of followers` of users in Burundi on `2024/5/12 12:49 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
