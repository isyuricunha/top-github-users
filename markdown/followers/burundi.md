...
The `number of followers` of users in Burundi on `2023/5/18 7:22 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
