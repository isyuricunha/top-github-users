...
The `number of followers` of users in Burundi on `2024/12/8 7:25 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
