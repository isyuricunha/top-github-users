...
The `number of followers` of users in Burundi on `2023/5/19 10:35 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
