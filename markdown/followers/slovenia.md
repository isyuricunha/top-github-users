...
The `number of followers` of users in Slovenia on `2024/1/9 10:47 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
