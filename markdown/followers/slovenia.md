...
The `number of followers` of users in Slovenia on `2024/10/4 11:43 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
