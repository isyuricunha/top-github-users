...
The `number of followers` of users in Slovenia on `2023/9/3 5:56 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
