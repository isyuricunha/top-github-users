...
The `number of followers` of users in Slovenia on `2024/4/28 7:16 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
