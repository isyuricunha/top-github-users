...
The `number of followers` of users in Slovenia on `2022/12/12 3:36 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
