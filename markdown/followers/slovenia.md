...
The `number of followers` of users in Slovenia on `2024/11/20 4:50 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
