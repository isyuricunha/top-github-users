...
The `number of followers` of users in Slovenia on `2024/8/9 5:44 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
