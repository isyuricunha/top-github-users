...
The `number of followers` of users in Slovenia on `2023/7/2 6:20 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
