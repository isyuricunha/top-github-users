...
The `number of followers` of users in Slovenia on `2023/6/21 4:19 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
