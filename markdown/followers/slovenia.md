...
The `number of followers` of users in Slovenia on `2024/10/22 4:46 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
