...
The `number of followers` of users in Slovenia on `2023/12/18 12:58 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
