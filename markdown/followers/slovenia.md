...
The `number of followers` of users in Slovenia on `2024/4/7 2:56 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
