...
The `number of followers` of users in Slovenia on `2022/12/8 9:19 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
