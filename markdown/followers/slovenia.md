...
The `number of followers` of users in Slovenia on `2023/6/24 6:38 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
