...
The `number of followers` of users in Slovenia on `2023/12/2 10:32 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
