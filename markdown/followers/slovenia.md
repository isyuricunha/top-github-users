...
The `number of followers` of users in Slovenia on `2022/11/16 3:41 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
