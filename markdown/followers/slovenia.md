...
The `number of followers` of users in Slovenia on `2024/12/5 9:22 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
