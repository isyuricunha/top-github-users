...
The `number of followers` of users in Slovenia on `2024/12/23 2:38 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
