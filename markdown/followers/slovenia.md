...
The `number of followers` of users in Slovenia on `2025/2/9 6:56 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
