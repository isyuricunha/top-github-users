...
The `number of followers` of users in Slovenia on `2024/5/1 4:56 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
