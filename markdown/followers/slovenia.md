...
The `number of followers` of users in Slovenia on `2023/3/24 5:32 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
