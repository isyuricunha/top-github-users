...
The `number of followers` of users in Slovenia on `2023/11/24 7:57 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
