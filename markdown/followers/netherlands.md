...
The `number of followers` of users in Netherlands on `2023/6/26 8:30 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LegacyGamerHD">
				<img src="https://avatars.githubusercontent.com/u/25864932?s=72&u=f18a45490ec9f8d2026637d955cfcc8e2212fced&v=4" width="24" alt="Avatar of LegacyGamerHD"> LegacyGamerHD
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
