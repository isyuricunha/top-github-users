...
The `number of followers` of users in Netherlands on `2025/1/29 5:53 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `939 users`  in Netherlands. You need at least `145 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dudemelo">
				<img src="https://avatars.githubusercontent.com/u/1172271?s=72&u=98a898f8a02f53a6961b1ff94826748df2ba0b1e&v=4" width="24" alt="Avatar of dudemelo"> dudemelo
			</a><br/>
			jfmelo
		</td>
		<td>@scribbr  </td>
