...
The `number of followers` of users in Netherlands on `2023/8/14 8:57 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `970 users`  in Netherlands. You need at least `116 followers` to be on this list.
