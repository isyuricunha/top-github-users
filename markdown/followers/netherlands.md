...
The `number of followers` of users in Netherlands on `2024/5/9 9:43 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `953 users`  in Netherlands. You need at least `130 followers` to be on this list.
