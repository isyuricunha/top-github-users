...
The `number of followers` of users in Netherlands on `2024/8/2 1:00 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `948 users`  in Netherlands. You need at least `135 followers` to be on this list.
