...
The `number of followers` of users in Netherlands on `2025/1/2 11:59 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.
