...
The `number of followers` of users in Poland on `2023/12/21 5:19 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
