...
The `number of followers` of users in Poland on `2023/2/10 3:14 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
