...
The `number of followers` of users in Poland on `2022/12/29 9:39 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
