...
The `number of followers` of users in Poland on `2022/11/14 5:09 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
