...
The `number of followers` of users in Poland on `2023/12/8 12:54 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
