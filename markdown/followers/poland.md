...
The `number of followers` of users in Poland on `2024/12/19 8:28 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
