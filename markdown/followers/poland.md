...
The `number of followers` of users in Poland on `2023/10/12 11:19 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
...
<table>
	...
	<tr>
		...
		<td>Shiji Group </td>
		<td><a href="https://twitter.com/RyczkoKonrad">RyczkoKonrad</a></td>
		<td>Szczecin, Poland</td>
		<td>61</td>
	</tr>
	<tr>
