...
The `number of followers` of users in Poland on `2023/2/19 7:31 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
