...
The `number of followers` of users in Poland on `2022/12/13 8:32 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
