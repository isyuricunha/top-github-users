...
The `number of followers` of users in Poland on `2022/11/7 7:42 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
