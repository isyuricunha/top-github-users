...
The `number of followers` of users in Poland on `2023/9/11 8:57 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `964 users`  in Poland. You need at least `60 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@presidentialtitle @elowro  </td>
		<td>No Twitter Username</td>
