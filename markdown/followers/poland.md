...
The `number of followers` of users in Poland on `2024/6/28 3:21 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
