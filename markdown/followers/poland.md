...
The `number of followers` of users in Poland on `2023/10/14 4:20 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
