...
The `number of followers` of users in Poland on `2023/10/9 3:19 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `963 users`  in Poland. You need at least `61 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/aerosol">
				<img src="https://avatars.githubusercontent.com/u/173738?s=72&u=bd26f0f812925079ccd676d017d1e5b42f2fd266&v=4" width="24" alt="Avatar of aerosol"> aerosol
			</a><br/>
			hq1
		</td>
		<td>@plausible </td>
