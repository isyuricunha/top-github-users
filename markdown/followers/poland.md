...
The `number of followers` of users in Poland on `2023/2/24 6:22 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
