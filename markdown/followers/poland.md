...
The `number of followers` of users in Poland on `2024/7/16 3:44 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
