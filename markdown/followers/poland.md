...
The `number of followers` of users in Poland on `2023/4/6 11:30 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
