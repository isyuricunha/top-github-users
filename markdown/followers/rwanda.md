...
The `number of followers` of users in Rwanda on `2023/12/4 1:56 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `968 users`  in Rwanda. You need at least `4 followers` to be on this list.
