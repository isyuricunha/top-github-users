...
The `number of followers` of users in Rwanda on `2023/11/22 11:42 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `972 users`  in Rwanda. You need at least `4 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Mugabe000">
				<img src="https://avatars.githubusercontent.com/u/99413885?s=72&v=4" width="24" alt="Avatar of Mugabe000"> Mugabe000
			</a><br/>
			Mugabe Ignace
		</td>
		<td>No Company</td>
