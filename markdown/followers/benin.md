...
The `number of followers` of users in Benin on `2023/5/2 7:25 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
