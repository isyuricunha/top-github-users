...
The `number of followers` of users in Benin on `2024/9/5 8:40 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
