...
The `number of followers` of users in Benin on `2022/12/19 9:55 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
