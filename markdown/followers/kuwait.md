...
The `number of followers` of users in Kuwait on `2025/2/11 6:23 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
