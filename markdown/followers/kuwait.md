...
The `number of followers` of users in Kuwait on `2023/6/3 8:40 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
