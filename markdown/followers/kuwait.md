...
The `number of followers` of users in Kuwait on `2023/6/25 11:15 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
