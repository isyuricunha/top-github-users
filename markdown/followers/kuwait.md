...
The `number of followers` of users in Kuwait on `2023/5/25 12:56 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
