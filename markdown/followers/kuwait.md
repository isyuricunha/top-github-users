...
The `number of followers` of users in Kuwait on `2024/8/27 1:22 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
