...
The `number of followers` of users in Kuwait on `2023/12/19 3:40 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
