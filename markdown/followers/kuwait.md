...
The `number of followers` of users in Kuwait on `2022/11/28 4:56 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
