...
The `number of followers` of users in Kuwait on `2023/8/5 7:40 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
