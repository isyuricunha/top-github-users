...
The `number of followers` of users in Kuwait on `2024/3/20 8:29 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
