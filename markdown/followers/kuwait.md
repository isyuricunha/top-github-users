...
The `number of followers` of users in Kuwait on `2024/6/4 10:17 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
