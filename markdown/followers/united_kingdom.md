...
The `number of followers` of users in United Kingdom on `2024/7/28 1:03 AM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.
