...
The `number of followers` of users in United Kingdom on `2024/7/22 1:39 PM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `955 users`  in United Kingdom. You need at least `211 followers` to be on this list.
