...
The `number of followers` of users in Paraguay on `2025/1/18 8:56 AM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/tenondev_">tenondev_</a></td>
		<td>Asunción, Paraguay</td>
		<td>52</td>
	</tr>
	<tr>
