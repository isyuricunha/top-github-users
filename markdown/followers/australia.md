...
The `number of followers` of users in Australia on `2025/6/25 2:41 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		<td>484</td>
		<td>
			<a href="https://github.com/piobox2001">
