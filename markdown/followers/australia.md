...
The `number of followers` of users in Australia on `2025/9/3 12:47 AM UTC`. This list contains users from `Australia` and cities `Sydney` `Melbourne` `Perth` `Adelaide` `Brisbane` `Canberra` `Hobart` `Gold-coast` `Darwin`.
...
<table>
	...
	<tr>
		...
		<td>@vandelay-technologi  </td>
		<td><a href="https://twitter.com/DeFi_Vandelay">DeFi_Vandelay</a></td>
		<td>Sydney, Australia</td>
		<td>175</td>
	</tr>
	<tr>
