...
The `number of followers` of users in Saudi Arabia on `2022/12/31 5:55 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
