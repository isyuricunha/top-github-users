...
The `number of followers` of users in Saudi Arabia on `2024/9/20 3:01 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
