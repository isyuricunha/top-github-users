...
The `number of followers` of users in Saudi Arabia on `2024/4/3 4:38 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
