...
The `number of followers` of users in Saudi Arabia on `2024/1/26 7:25 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
