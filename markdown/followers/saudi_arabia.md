...
The `number of followers` of users in Saudi Arabia on `2023/12/13 6:46 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
