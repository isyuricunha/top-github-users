...
The `number of followers` of users in Saudi Arabia on `2023/3/22 10:43 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
