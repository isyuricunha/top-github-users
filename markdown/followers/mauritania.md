...
The `number of followers` of users in Mauritania on `2024/5/1 5:49 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
