...
The `number of followers` of users in Mauritania on `2023/5/20 3:22 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
