...
The `number of followers` of users in Mauritania on `2024/4/15 9:23 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
