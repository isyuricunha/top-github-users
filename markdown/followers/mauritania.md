...
The `number of followers` of users in Mauritania on `2024/3/20 11:11 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
