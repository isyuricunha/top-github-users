...
The `number of followers` of users in Mauritania on `2023/2/13 9:11 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
