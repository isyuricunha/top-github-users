...
The `number of followers` of users in Mauritania on `2022/12/15 10:42 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
