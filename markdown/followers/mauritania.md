...
The `number of followers` of users in Mauritania on `2025/1/11 4:15 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
