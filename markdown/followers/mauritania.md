...
The `number of followers` of users in Mauritania on `2024/5/13 5:12 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
