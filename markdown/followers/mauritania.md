...
The `number of followers` of users in Mauritania on `2024/7/18 4:49 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
