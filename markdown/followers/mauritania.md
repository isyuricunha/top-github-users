...
The `number of followers` of users in Mauritania on `2024/12/21 3:34 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
