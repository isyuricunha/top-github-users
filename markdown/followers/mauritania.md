...
The `number of followers` of users in Mauritania on `2024/11/1 12:57 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
