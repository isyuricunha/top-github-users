...
The `number of followers` of users in Mauritania on `2024/7/25 12:52 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
