...
The `number of followers` of users in Mauritania on `2023/1/2 4:42 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
