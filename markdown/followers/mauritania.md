...
The `number of followers` of users in Mauritania on `2022/11/11 11:43 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
