...
The `number of followers` of users in Mauritania on `2024/10/26 7:12 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
