...
The `number of followers` of users in Mauritania on `2024/11/20 3:54 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
