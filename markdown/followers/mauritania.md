...
The `number of followers` of users in Mauritania on `2025/2/11 9:30 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
