...
The `number of followers` of users in Mauritania on `2024/11/17 9:12 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
