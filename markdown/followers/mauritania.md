...
The `number of followers` of users in Mauritania on `2024/6/1 1:24 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
