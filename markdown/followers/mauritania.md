...
The `number of followers` of users in Mauritania on `2023/10/12 5:26 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
