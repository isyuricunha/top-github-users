...
The `number of followers` of users in Mauritania on `2022/11/18 4:53 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
