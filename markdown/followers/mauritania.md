...
The `number of followers` of users in Mauritania on `2024/5/30 6:16 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
