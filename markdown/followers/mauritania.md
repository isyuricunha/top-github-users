...
The `number of followers` of users in Mauritania on `2024/4/29 11:50 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
