...
The `number of followers` of users in Mauritania on `2024/10/18 2:17 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
