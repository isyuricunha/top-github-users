...
The `number of followers` of users in Jamaica on `2022/12/20 2:34 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
