...
The `number of followers` of users in Jamaica on `2023/4/23 7:40 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
