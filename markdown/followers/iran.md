...
The `number of followers` of users in Iran on `2024/11/15 1:48 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
