...
The `number of followers` of users in Iran on `2023/3/1 6:20 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
