...
The `number of followers` of users in Iran on `2023/3/11 3:00 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
