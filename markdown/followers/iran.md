...
The `number of followers` of users in Iran on `2024/9/9 4:56 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
