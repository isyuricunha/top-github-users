...
The `number of followers` of users in Iran on `2022/12/25 7:41 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
