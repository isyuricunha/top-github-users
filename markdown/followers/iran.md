...
The `number of followers` of users in Iran on `2022/11/17 7:42 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
