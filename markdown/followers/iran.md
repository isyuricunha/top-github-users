...
The `number of followers` of users in Iran on `2024/10/1 1:34 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
