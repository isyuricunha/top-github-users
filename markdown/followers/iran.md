...
The `number of followers` of users in Iran on `2024/8/5 6:48 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
