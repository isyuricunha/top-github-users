...
The `number of followers` of users in Kenya on `2024/10/26 3:26 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
