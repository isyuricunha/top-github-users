...
The `number of followers` of users in Kenya on `2024/12/26 11:21 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
