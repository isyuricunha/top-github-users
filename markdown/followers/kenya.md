...
The `number of followers` of users in Kenya on `2025/1/26 9:33 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
