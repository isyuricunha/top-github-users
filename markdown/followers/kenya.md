...
The `number of followers` of users in Kenya on `2024/11/13 2:21 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
