...
The `number of followers` of users in Kenya on `2024/10/23 11:20 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
