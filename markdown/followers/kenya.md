...
The `number of followers` of users in Kenya on `2024/12/24 11:58 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
