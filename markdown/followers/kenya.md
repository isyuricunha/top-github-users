...
The `number of followers` of users in Kenya on `2025/1/8 11:58 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
