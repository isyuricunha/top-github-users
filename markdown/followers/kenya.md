...
The `number of followers` of users in Kenya on `2024/11/19 9:58 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
