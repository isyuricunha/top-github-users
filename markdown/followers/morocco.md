...
The `number of followers` of users in Morocco on `2023/7/7 11:56 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
