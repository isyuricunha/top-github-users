...
The `number of followers` of users in Morocco on `2023/9/4 12:55 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
