...
The `number of followers` of users in Morocco on `2023/8/28 8:30 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
