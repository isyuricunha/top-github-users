...
The `number of followers` of users in Morocco on `2024/12/9 7:32 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
