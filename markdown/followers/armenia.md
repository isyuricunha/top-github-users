...
The `number of followers` of users in Armenia on `2024/9/30 6:51 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
