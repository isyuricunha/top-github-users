...
The `number of followers` of users in Armenia on `2024/1/9 7:41 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
