...
The `number of followers` of users in Armenia on `2023/6/28 10:36 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
