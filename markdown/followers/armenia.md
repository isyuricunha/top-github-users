...
The `number of followers` of users in Armenia on `2024/2/7 3:29 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
