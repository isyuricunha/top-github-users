...
The `number of followers` of users in Armenia on `2024/10/17 1:05 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
