...
The `number of followers` of users in Armenia on `2024/2/5 10:55 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
