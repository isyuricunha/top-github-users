...
The `number of followers` of users in Armenia on `2024/6/20 7:42 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
