...
The `number of followers` of users in Armenia on `2024/3/16 6:45 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
