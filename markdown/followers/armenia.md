...
The `number of followers` of users in Armenia on `2023/10/6 8:17 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/karpetrosyan">
				<img src="https://avatars.githubusercontent.com/u/92274156?s=72&v=4" width="24" alt="Avatar of karpetrosyan"> karpetrosyan
			</a><br/>
			Kar Petrosyan
		</td>
		<td>No Company</td>
