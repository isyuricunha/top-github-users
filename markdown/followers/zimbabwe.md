...
The `number of followers` of users in Zimbabwe on `2024/7/13 10:42 AM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/noothingmatterss">
				<img src="https://avatars.githubusercontent.com/u/127596858?s=72&u=cf81ce3a8084945dbe4758ce95a9747b46ba2be4&v=4" width="24" alt="Avatar of noothingmatterss"> noothingmatterss
			</a><br/>
			moonhead
		</td>
		<td>No Company</td>
