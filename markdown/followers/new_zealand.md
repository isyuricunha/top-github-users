...
The `number of followers` of users in New Zealand on `2023/7/7 2:17 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
