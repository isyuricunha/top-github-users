...
The `number of followers` of users in Mozambique  on `2022/11/30 9:17 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
