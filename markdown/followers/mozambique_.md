...
The `number of followers` of users in Mozambique  on `2023/8/20 5:54 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
