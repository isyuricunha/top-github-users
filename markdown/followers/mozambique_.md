...
The `number of followers` of users in Mozambique  on `2023/11/30 9:40 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
