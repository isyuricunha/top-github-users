...
The `number of followers` of users in Mozambique  on `2023/9/14 1:19 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
