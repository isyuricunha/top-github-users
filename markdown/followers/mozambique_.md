...
The `number of followers` of users in Mozambique  on `2024/11/28 5:36 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
