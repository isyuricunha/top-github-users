...
The `number of followers` of users in Mozambique  on `2023/2/11 3:54 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
