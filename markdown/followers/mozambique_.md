...
The `number of followers` of users in Mozambique  on `2024/4/21 2:45 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
