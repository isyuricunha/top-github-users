...
The `number of followers` of users in Mozambique  on `2024/10/1 10:18 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
