...
The `number of followers` of users in Mozambique  on `2024/8/3 8:17 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
