...
The `number of followers` of users in Mozambique  on `2024/12/9 7:42 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
