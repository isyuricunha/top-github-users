...
The `number of followers` of users in Mozambique  on `2024/5/15 2:28 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
