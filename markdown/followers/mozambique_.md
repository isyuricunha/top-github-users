...
The `number of followers` of users in Mozambique  on `2024/3/27 4:19 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
