...
The `number of followers` of users in Mozambique  on `2023/9/7 10:39 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
