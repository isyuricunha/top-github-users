...
The `number of followers` of users in Mozambique  on `2025/2/9 9:17 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
