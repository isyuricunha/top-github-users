...
The `number of followers` of users in Mozambique  on `2024/5/6 11:14 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
