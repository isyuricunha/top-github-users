...
The `number of followers` of users in Mozambique  on `2023/11/17 3:16 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
