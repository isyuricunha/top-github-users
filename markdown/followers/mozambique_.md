...
The `number of followers` of users in Mozambique  on `2023/1/4 3:17 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
