...
The `number of followers` of users in Mozambique  on `2024/11/7 7:27 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
