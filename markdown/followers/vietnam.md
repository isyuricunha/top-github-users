...
The `number of followers` of users in Vietnam on `2023/11/21 2:51 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Rum_1337">Rum_1337</a></td>
		<td>Vietnam</td>
		<td>27</td>
	</tr>
	<tr>
