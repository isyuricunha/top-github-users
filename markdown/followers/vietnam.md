...
The `number of followers` of users in Vietnam on `2024/8/2 4:57 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `953 users`  in Vietnam. You need at least `31 followers` to be on this list.
