...
The `number of followers` of users in Vietnam on `2025/1/7 7:57 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
