...
The `number of followers` of users in Vietnam on `2024/4/12 9:42 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
