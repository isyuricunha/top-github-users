...
The `number of followers` of users in Vietnam on `2023/8/11 5:30 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
