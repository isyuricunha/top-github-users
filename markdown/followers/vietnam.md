...
The `number of followers` of users in Vietnam on `2024/2/27 7:18 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
