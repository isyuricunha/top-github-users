...
The `number of followers` of users in Vietnam on `2024/9/12 5:46 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
...
<table>
	...
	<tr>
		...
		<td>Cmc Technology And Solution<br/></td>
		<td>No Twitter Username</td>
		<td>Saigon, Vietnam</td>
		<td>37</td>
	</tr>
