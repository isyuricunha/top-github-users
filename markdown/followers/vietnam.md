...
The `number of followers` of users in Vietnam on `2023/8/21 8:35 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
