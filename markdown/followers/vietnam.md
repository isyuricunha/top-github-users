...
The `number of followers` of users in Vietnam on `2023/10/1 5:32 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
