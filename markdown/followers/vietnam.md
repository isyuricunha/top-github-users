...
The `number of followers` of users in Vietnam on `2024/6/9 9:56 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Vietnam, Earth, Milky Way, Laniakea</td>
		<td>60</td>
	</tr>
	<tr>
		<td>382</td>
