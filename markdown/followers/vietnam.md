...
The `number of followers` of users in Vietnam on `2024/12/21 9:43 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
