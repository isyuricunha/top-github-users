...
The `number of followers` of users in Norway on `2024/10/24 10:24 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `935 users`  in Norway. You need at least `41 followers` to be on this list.
