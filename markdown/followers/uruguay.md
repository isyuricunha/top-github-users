...
The `number of followers` of users in Uruguay on `2023/9/24 11:41 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `967 users`  in Uruguay. You need at least `7 followers` to be on this list.
