...
The `number of followers` of users in Sri Lanka on `2023/12/18 2:17 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
...
<table>
	...
	<tr>
		...
		<td>Verdentra / Meazure Learning<br/></td>
		<td>No Twitter Username</td>
		<td>Colombo</td>
		<td>12</td>
	</tr>
