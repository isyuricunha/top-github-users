...
The `number of followers` of users in Sri Lanka on `2025/10/28 2:25 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
