...
The `number of followers` of users in Bhutan on `2022/12/25 8:41 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
