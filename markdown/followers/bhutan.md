...
The `number of followers` of users in Bhutan on `2023/4/4 6:41 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
