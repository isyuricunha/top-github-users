...
The `number of followers` of users in Bhutan on `2023/1/21 7:51 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
