...
The `number of followers` of users in Bhutan on `2022/11/23 1:41 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
