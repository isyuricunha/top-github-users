...
The `number of followers` of users in Bhutan on `2022/12/30 2:36 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.
