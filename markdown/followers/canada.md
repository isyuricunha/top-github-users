...
The `number of followers` of users in Canada on `2024/10/27 11:44 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
...
<table>
	...
	<tr>
		<td>938</td>
		<td>
			<a href="https://github.com/qservices-process-automation-partners">
		...
		<td><a href="https://twitter.com/qservicesit">qservicesit</a></td>
		<td>Mississauga , Canada</td>
		<td>213</td>
	</tr>
	<tr>
