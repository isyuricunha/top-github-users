...
The `number of followers` of users in Malta on `2023/9/9 12:45 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `892 users`  in Malta. You need at least `0 followers` to be on this list.
