...
The `number of followers` of users in Japan on `2024/12/14 7:07 AM UTC`. This list contains users from `Japan` and cities `Tokyo`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `782 users`  in Japan. You need at least `223 followers` to be on this list.
