...
The `number of followers` of users in Turkey on `2024/5/10 9:32 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
