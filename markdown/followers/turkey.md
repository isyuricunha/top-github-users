...
The `number of followers` of users in Turkey on `2024/11/8 11:31 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
