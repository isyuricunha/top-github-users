...
The `number of followers` of users in Turkey on `2024/12/17 1:12 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
