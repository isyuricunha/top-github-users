...
The `number of followers` of users in Andorra on `2023/5/28 3:25 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
