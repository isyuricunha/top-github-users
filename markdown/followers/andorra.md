...
The `number of followers` of users in Andorra on `2024/12/24 1:00 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
