...
The `number of followers` of users in Belgium on `2025/1/1 8:25 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
