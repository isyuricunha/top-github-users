...
The `number of followers` of users in Belgium on `2025/1/3 10:59 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
