...
The `number of followers` of users in Belgium on `2024/12/13 10:47 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
