...
The `number of followers` of users in Hungary on `2023/2/3 11:55 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.
