...
The `number of followers` of users in Lithuania on `2025/10/4 2:09 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
