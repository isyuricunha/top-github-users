...
The `number of followers` of users in Lithuania on `2024/10/28 4:24 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
...
<table>
	...
	<tr>
		...
		<td>@epitech @logigroup @gediminas @moboo<br/>@sigmaexplorer<br/><br/></td>
		<td>No Twitter Username</td>
