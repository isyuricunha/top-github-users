...
The `number of followers` of users in Lithuania on `2022/12/27 5:59 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
