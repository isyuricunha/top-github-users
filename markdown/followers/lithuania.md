...
The `number of followers` of users in Lithuania on `2024/5/13 3:19 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
