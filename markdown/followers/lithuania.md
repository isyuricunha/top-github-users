...
The `number of followers` of users in Lithuania on `2023/2/17 3:11 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
