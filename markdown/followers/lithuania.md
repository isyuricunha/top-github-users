...
The `number of followers` of users in Lithuania on `2024/8/1 7:29 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
