...
The `number of followers` of users in Lithuania on `2024/2/19 8:29 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
