...
The `number of followers` of users in South Africa on `2022/12/26 2:20 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
