...
The `number of followers` of users in South Africa on `2023/8/1 9:56 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/AbstractD3v">AbstractD3v</a></td>
		<td>Johannesburg, South Africa</td>
		<td>19</td>
	</tr>
	<tr>
