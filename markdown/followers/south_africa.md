...
The `number of followers` of users in South Africa on `2024/11/14 7:57 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
