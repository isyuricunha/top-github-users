...
The `number of followers` of users in South Africa on `2025/6/10 12:50 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
...
<table>
	...
	<tr>
		...
		<td>Capaciti </td>
		<td><a href="https://twitter.com/df_rori">df_rori</a></td>
		<td>Johannesburg, South Africa</td>
		<td>29</td>
	</tr>
	<tr>
