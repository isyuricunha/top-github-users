...
The `number of followers` of users in South Africa on `2023/1/4 11:39 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
