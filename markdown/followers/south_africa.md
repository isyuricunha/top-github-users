...
The `number of followers` of users in South Africa on `2024/6/28 7:41 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
