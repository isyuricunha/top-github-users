...
The `number of followers` of users in South Africa on `2023/4/18 8:56 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
