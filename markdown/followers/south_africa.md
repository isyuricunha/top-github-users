...
The `number of followers` of users in South Africa on `2024/8/22 3:38 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
