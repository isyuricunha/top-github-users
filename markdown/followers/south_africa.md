...
The `number of followers` of users in South Africa on `2023/8/6 9:56 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `983 users`  in South Africa. You need at least `13 followers` to be on this list.
