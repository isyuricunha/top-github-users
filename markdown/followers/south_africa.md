...
The `number of followers` of users in South Africa on `2024/7/5 10:36 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `971 users`  in South Africa. You need at least `14 followers` to be on this list.
