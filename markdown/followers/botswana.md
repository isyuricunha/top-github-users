...
The `number of followers` of users in Botswana on `2023/8/3 2:52 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
