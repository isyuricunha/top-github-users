...
The `number of followers` of users in Botswana on `2024/2/4 11:22 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
