...
The `number of followers` of users in Botswana on `2023/11/7 5:39 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
