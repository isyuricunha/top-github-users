...
The `number of followers` of users in Botswana on `2022/12/1 10:16 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
