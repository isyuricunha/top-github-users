...
The `number of followers` of users in Botswana on `2024/2/27 1:14 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
