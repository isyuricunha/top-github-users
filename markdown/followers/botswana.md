...
The `number of followers` of users in Botswana on `2024/4/23 3:38 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
