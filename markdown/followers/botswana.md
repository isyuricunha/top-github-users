...
The `number of followers` of users in Botswana on `2024/1/22 5:32 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
