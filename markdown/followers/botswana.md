...
The `number of followers` of users in Botswana on `2023/8/29 6:40 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
