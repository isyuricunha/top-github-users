...
The `number of followers` of users in Botswana on `2024/12/10 11:33 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
