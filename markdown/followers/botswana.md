...
The `number of followers` of users in Botswana on `2024/1/9 10:40 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
