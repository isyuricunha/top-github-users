...
The `number of followers` of users in Botswana on `2025/1/14 6:46 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
