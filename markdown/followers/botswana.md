...
The `number of followers` of users in Botswana on `2024/8/4 6:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
