...
The `number of followers` of users in Botswana on `2024/12/4 7:19 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
