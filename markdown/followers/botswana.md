...
The `number of followers` of users in Botswana on `2024/2/25 8:26 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
