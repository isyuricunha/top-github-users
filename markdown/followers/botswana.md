...
The `number of followers` of users in Botswana on `2024/7/2 9:28 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
