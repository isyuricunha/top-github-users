...
The `number of followers` of users in Botswana on `2024/4/25 9:15 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
