...
The `number of followers` of users in Botswana on `2023/12/8 6:17 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
