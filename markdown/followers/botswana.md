...
The `number of followers` of users in Botswana on `2023/6/25 9:38 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
