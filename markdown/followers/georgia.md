...
The `number of followers` of users in Georgia on `2024/12/13 10:42 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
