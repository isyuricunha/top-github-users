...
The `number of followers` of users in Georgia on `2023/10/18 10:17 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
