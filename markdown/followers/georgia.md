...
The `number of followers` of users in Georgia on `2023/11/30 10:37 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
