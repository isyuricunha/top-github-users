...
The `number of followers` of users in Georgia on `2024/12/18 11:20 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
