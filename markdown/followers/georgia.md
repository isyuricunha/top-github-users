...
The `number of followers` of users in Georgia on `2024/6/20 7:42 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		...
		<td>Kms Technology </td>
		<td><a href="https://twitter.com/trietphamnm">trietphamnm</a></td>
		<td>Atlanta, Georgia US</td>
		<td>16</td>
	</tr>
	<tr>
