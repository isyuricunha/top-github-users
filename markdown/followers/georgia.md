...
The `number of followers` of users in Georgia on `2025/9/22 2:30 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Dominiff">Dominiff</a></td>
		<td>Tbilisi, Georgia</td>
		<td>24</td>
	</tr>
	<tr>
