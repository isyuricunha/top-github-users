...
The `number of followers` of users in Venezuela on `2024/10/6 5:36 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
