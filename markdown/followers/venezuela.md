...
The `number of followers` of users in Venezuela on `2024/3/8 9:55 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
