...
The `number of followers` of users in Venezuela on `2023/8/8 7:27 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
