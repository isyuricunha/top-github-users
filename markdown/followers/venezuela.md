...
The `number of followers` of users in Venezuela on `2024/8/4 11:42 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
