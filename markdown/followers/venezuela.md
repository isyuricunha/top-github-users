...
The `number of followers` of users in Venezuela on `2023/8/24 2:41 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
