...
The `number of followers` of users in Venezuela on `2023/9/6 8:30 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
