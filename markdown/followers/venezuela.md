...
The `number of followers` of users in Venezuela on `2024/5/22 3:56 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
