...
The `number of followers` of users in Venezuela on `2023/5/19 3:41 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
