...
The `number of followers` of users in Venezuela on `2023/9/11 6:43 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
