...
The `number of followers` of users in Venezuela on `2023/9/18 9:17 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
