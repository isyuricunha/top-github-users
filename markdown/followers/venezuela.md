...
The `number of followers` of users in Venezuela on `2024/11/12 12:31 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
