...
The `number of followers` of users in Venezuela on `2023/7/17 10:19 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
