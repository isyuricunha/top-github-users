...
The `number of followers` of users in Venezuela on `2023/4/2 8:33 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
