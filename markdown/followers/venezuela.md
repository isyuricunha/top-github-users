...
The `number of followers` of users in Venezuela on `2024/11/14 2:58 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
