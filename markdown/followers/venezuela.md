...
The `number of followers` of users in Venezuela on `2023/3/8 9:43 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
