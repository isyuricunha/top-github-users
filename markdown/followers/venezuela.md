...
The `number of followers` of users in Venezuela on `2024/9/1 5:47 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
