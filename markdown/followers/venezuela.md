...
The `number of followers` of users in Venezuela on `2024/4/23 8:56 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
