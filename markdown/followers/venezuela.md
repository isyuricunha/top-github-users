...
The `number of followers` of users in Venezuela on `2024/4/30 5:34 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
