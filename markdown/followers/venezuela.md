...
The `number of followers` of users in Venezuela on `2023/9/26 5:32 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
