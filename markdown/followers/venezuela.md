...
The `number of followers` of users in Venezuela on `2023/3/15 5:35 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
