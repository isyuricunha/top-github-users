...
The `number of followers` of users in Venezuela on `2023/1/23 9:33 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
