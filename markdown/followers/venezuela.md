...
The `number of followers` of users in Venezuela on `2024/1/25 11:16 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
