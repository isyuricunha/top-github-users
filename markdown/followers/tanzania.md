...
The `number of followers` of users in Tanzania on `2023/11/7 7:27 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
