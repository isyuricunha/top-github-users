...
The `number of followers` of users in Tanzania on `2024/4/28 9:28 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
