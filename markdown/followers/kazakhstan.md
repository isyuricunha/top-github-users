...
The `number of followers` of users in Kazakhstan on `2025/7/24 12:52 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>San Francisco, Kazakhstan</td>
		<td>34</td>
	</tr>
	<tr>
		<td>212</td>
