...
The `number of followers` of users in Iraq on `2024/4/6 10:55 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Mo_Sa_Shaeerah">Mo_Sa_Shaeerah</a></td>
		<td>Baghdad (Iraq)</td>
		<td>6</td>
	</tr>
	<tr>
