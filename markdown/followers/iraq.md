...
The `number of followers` of users in Iraq on `2024/5/30 11:56 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `945 users`  in Iraq. You need at least `4 followers` to be on this list.
