...
The `number of followers` of users in Iraq on `2024/7/5 6:56 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
