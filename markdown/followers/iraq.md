...
The `number of followers` of users in Iraq on `2024/6/8 10:44 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
...
<table>
	...
	<tr>
		<td>817</td>
		<td>
			<a href="https://github.com/Lily-Robinson">
				<img src="https://avatars.githubusercontent.com/u/170073716?s=72&v=4" width="24" alt="Avatar of Lily-Robinson"> Lily-Robinson
			</a><br/>
			Lily Robinson
		</td>
		<td>Asiacell </td>
