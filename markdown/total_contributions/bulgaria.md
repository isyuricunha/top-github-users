...
The `public contributions` and `private contributions` by users in Bulgaria on `2023/10/31 10:33 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/krislazarev">krislazarev</a></td>
		<td>Bulgaria, Sofia</td>
		<td>395</td>
		<td>395</td>
	</tr>
