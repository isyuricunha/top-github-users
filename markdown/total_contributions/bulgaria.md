...
The `public contributions` and `private contributions` by users in Bulgaria on `2025/4/23 12:48 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
