...
The `public contributions` and `private contributions` by users in Bulgaria on `2024/2/7 6:56 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/panayotsky-dev">
				<img src="https://avatars.githubusercontent.com/u/104060829?s=72&u=25fb3181d057983a6536b3af4baa225ad85ebb92&v=4" width="24" alt="Avatar of panayotsky-dev"> panayotsky-dev
			</a><br/>
			Panayot Petkov
		</td>
		<td>No Company</td>
