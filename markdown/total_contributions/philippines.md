...
The `public contributions` and `private contributions` by users in Philippines on `2025/1/18 9:35 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
