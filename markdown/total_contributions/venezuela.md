...
The `public contributions` and `private contributions` by users in Venezuela on `2023/12/1 12:57 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
