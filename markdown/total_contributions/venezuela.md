...
The `public contributions` and `private contributions` by users in Venezuela on `2022/12/21 11:42 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
