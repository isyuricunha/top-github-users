...
The `public contributions` and `private contributions` by users in Venezuela on `2022/11/25 5:43 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
