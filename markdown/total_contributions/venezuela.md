...
The `public contributions` and `private contributions` by users in Venezuela on `2023/2/28 9:31 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
