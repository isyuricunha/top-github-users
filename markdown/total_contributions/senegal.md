...
The `public contributions` and `private contributions` by users in Senegal on `2023/8/14 2:40 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
