...
The `public contributions` and `private contributions` by users in Senegal on `2022/12/13 10:42 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
