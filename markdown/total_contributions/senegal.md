...
The `public contributions` and `private contributions` by users in Senegal on `2023/6/21 2:59 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.
