...
The `public contributions` and `private contributions` by users in Senegal on `2023/1/17 12:25 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
