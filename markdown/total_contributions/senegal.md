...
The `public contributions` and `private contributions` by users in Senegal on `2023/4/23 8:40 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.
