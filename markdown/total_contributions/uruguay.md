...
The `public contributions` and `private contributions` by users in Uruguay on `2022/12/14 8:00 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.
