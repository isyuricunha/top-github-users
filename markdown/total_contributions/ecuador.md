...
The `public contributions` and `private contributions` by users in Ecuador on `2023/12/19 7:56 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
