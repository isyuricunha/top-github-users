...
The `public contributions` and `private contributions` by users in Ecuador on `2024/10/23 3:21 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
