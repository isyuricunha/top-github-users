...
The `public contributions` and `private contributions` by users in Ecuador on `2024/4/12 8:56 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
