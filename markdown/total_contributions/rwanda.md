...
The `public contributions` and `private contributions` by users in Rwanda on `2023/8/12 10:29 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
