...
The `public contributions` and `private contributions` by users in Rwanda on `2022/12/28 5:56 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
