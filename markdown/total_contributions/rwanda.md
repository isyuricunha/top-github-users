...
The `public contributions` and `private contributions` by users in Rwanda on `2022/11/11 10:40 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.
