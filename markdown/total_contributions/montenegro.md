...
The `public contributions` and `private contributions` by users in Montenegro on `2023/6/6 10:55 PM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.
...
<table>
	...
	<tr>
		<td>647</td>
		<td>
			<a href="https://github.com/TascalEngineeringMe">
				<img src="https://avatars.githubusercontent.com/u/118835028?s=72&v=4" width="24" alt="Avatar of TascalEngineeringMe"> TascalEngineeringMe
			</a><br/>
			JoxoMow
		</td>
		<td>Tascal Engineering D.o.o. </td>
		<td><a href="https://twitter.com/JoxoMow">JoxoMow</a></td>
		<td>Podgorica, Montenegro</td>
		<td>1</td>
		<td>1</td>
	</tr>
