...
The `public contributions` and `private contributions` by users in France on `2024/6/24 8:41 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tchiotludo">
				<img src="https://avatars.githubusercontent.com/u/2064609?s=72&u=42998a4c6180c27dcb3c43f06daf1c4b9bdd71e5&v=4" width="24" alt="Avatar of tchiotludo"> tchiotludo
			</a><br/>
			Ludovic DEHON
		</td>
		<td>@kestra-io </td>
