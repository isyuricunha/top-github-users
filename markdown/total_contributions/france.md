...
The `public contributions` and `private contributions` by users in France on `2023/8/28 9:58 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `960 users`  in France. You need at least `152 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/pablo-1610">
				<img src="https://avatars.githubusercontent.com/u/42814853?s=72&u=b7e2cc9ae88f5aaeb9ddbb9322995dee491fc5a9&v=4" width="24" alt="Avatar of pablo-1610"> pablo-1610
			</a><br/>
			Pablo Zapata
		</td>
		<td>Slantingstds </td>
