...
The `public contributions` and `private contributions` by users in France on `2023/8/8 9:43 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Sn0wAlice">
				<img src="https://avatars.githubusercontent.com/u/38856824?s=72&u=a9e21c779d42c6375437839766a8f56d82fe8b01&v=4" width="24" alt="Avatar of Sn0wAlice"> Sn0wAlice
			</a><br/>
			Alice Snow
		</td>
		<td>Cyberpunk Corpo </td>
