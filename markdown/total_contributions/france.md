...
The `public contributions` and `private contributions` by users in France on `2023/8/10 3:58 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/hteumeuleu">
				<img src="https://avatars.githubusercontent.com/u/3451753?s=72&u=ec9273f383295556405f01f5a657744a6a496da2&v=4" width="24" alt="Avatar of hteumeuleu"> hteumeuleu
			</a><br/>
			HTeuMeuLeu
		</td>
		<td>No Company</td>
