...
The `public contributions` and `private contributions` by users in France on `2023/10/5 4:22 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `958 users`  in France. You need at least `156 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zqodev">
				<img src="https://avatars.githubusercontent.com/u/123120185?s=72&u=39e2f77a97d572101ed7757998e9e4553d22dfbe&v=4" width="24" alt="Avatar of zqodev"> zqodev
			</a><br/>
			zqo
		</td>
		<td>Chronosky </td>
