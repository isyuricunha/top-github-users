...
The `public contributions` and `private contributions` by users in France on `2024/6/18 11:34 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `945 users`  in France. You need at least `174 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MeymounB">
				<img src="https://avatars.githubusercontent.com/u/77726988?s=72&u=726d87989caa07b49f34a8dd54f191e0efb45659&v=4" width="24" alt="Avatar of MeymounB"> MeymounB
			</a><br/>
			Meymoun Boualaoui
		</td>
