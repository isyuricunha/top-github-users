...
The `public contributions` and `private contributions` by users in France on `2024/4/18 9:44 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
...
<table>
	...
	<tr>
		<td>888</td>
		<td>
			<a href="https://github.com/LinaMoro">
				<img src="https://avatars.githubusercontent.com/u/146819518?s=72&v=4" width="24" alt="Avatar of LinaMoro"> LinaMoro
			</a><br/>
			Lina Moro
		</td>
		<td>@zk-call </td>
