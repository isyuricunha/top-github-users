...
The `public contributions` and `private contributions` by users in France on `2023/6/23 8:20 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
...
<table>
	...
	<tr>
		...
		<td>Postman </td>
		<td><a href="https://twitter.com/tonygo_">tonygo_</a></td>
		<td>Paris, FR</td>
		<td>437</td>
		<td>766</td>
	</tr>
