...
The `public contributions` and `private contributions` by users in France on `2023/12/19 9:33 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `951 users`  in France. You need at least `156 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zeabdelkhalek">
				<img src="https://avatars.githubusercontent.com/u/34510420?s=72&v=4" width="24" alt="Avatar of zeabdelkhalek"> zeabdelkhalek
			</a><br/>
			Abdelkhalek Zellat
		</td>
		<td>No Company</td>
