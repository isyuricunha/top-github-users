...
The `public contributions` and `private contributions` by users in France on `2024/11/23 8:23 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `937 users`  in France. You need at least `186 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>568</td>
		<td>
			<a href="https://github.com/exaluc">
				<img src="https://avatars.githubusercontent.com/u/42606?s=72&u=6abbfc3df247fc95d336b4ec2d8fdf5303eb08c2&v=4" width="24" alt="Avatar of exaluc"> exaluc
			</a><br/>
			Lucian
		</td>
		<td>No Company</td>
