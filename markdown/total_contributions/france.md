...
The `public contributions` and `private contributions` by users in France on `2024/9/7 3:36 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
...
<table>
	...
	<tr>
		<td>563</td>
		<td>
			<a href="https://github.com/iusx">
				<img src="https://avatars.githubusercontent.com/u/57232813?s=72&u=9161fbc6af70bad22059e05ac0a9ac4f995a1823&v=4" width="24" alt="Avatar of iusx"> iusx
			</a><br/>
			ᗜ ‸ ᗜ
		</td>
		<td>@jangxue </td>
