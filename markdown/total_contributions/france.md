...
The `public contributions` and `private contributions` by users in France on `2024/4/30 7:43 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/geromegrignon">
				<img src="https://avatars.githubusercontent.com/u/32737308?s=72&u=2fb6eaea4b512562255146006f6f725a096627b5&v=4" width="24" alt="Avatar of geromegrignon"> geromegrignon
			</a><br/>
			Gerome Grignon
		</td>
		<td>Sfeir </td>
