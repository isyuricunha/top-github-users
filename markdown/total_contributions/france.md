...
The `public contributions` and `private contributions` by users in France on `2024/10/25 7:20 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `940 users`  in France. You need at least `184 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zqodev">
				<img src="https://avatars.githubusercontent.com/u/123120185?s=72&u=40e0a8006b920a448188f0a77127feb930509285&v=4" width="24" alt="Avatar of zqodev"> zqodev
			</a><br/>
			ZQO
		</td>
		<td>No Company</td>
