...
The `public contributions` and `private contributions` by users in France on `2024/9/27 8:52 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/valryon">
				<img src="https://avatars.githubusercontent.com/u/155884?s=72&u=c0eea2512fd3cb28797f3ab93a3377269e19d25a&v=4" width="24" alt="Avatar of valryon"> valryon
			</a><br/>
			Damien Mayance
		</td>
