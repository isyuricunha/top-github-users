...
The `public contributions` and `private contributions` by users in France on `2025/2/4 11:28 AM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `932 users`  in France. You need at least `193 followers` to be on this list.
