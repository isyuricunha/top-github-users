...
The `public contributions` and `private contributions` by users in Italy on `2023/12/31 6:20 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/fmarchioni">
				<img src="https://avatars.githubusercontent.com/u/1316493?s=72&u=fa650ce0e7edb4556e3068bf8ca37de16f6e87da&v=4" width="24" alt="Avatar of fmarchioni"> fmarchioni
			</a><br/>
			Francesco Marchioni
		</td>
		<td>Mastertheboss </td>
