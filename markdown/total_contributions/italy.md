...
The `public contributions` and `private contributions` by users in Italy on `2024/10/7 4:46 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/FedericoEl99143">FedericoEl99143</a></td>
		<td>Genoa</td>
		<td>303</td>
		<td>416</td>
	</tr>
