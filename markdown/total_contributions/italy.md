...
The `public contributions` and `private contributions` by users in Italy on `2023/9/9 8:19 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `979 users`  in Italy. You need at least `64 followers` to be on this list.
