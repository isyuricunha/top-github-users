...
The `public contributions` and `private contributions` by users in Switzerland on `2025/1/25 1:03 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
