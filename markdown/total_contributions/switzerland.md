...
The `public contributions` and `private contributions` by users in Switzerland on `2022/11/16 6:21 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
