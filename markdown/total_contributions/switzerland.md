...
The `public contributions` and `private contributions` by users in Switzerland on `2023/12/16 8:42 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
