...
The `public contributions` and `private contributions` by users in Switzerland on `2023/1/2 5:54 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
