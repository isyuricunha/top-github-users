...
The `public contributions` and `private contributions` by users in Switzerland on `2023/3/2 4:23 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
