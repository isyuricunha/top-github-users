...
The `public contributions` and `private contributions` by users in Spain on `2024/6/23 12:57 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
