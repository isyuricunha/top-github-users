...
The `public contributions` and `private contributions` by users in Spain on `2024/11/2 4:44 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
