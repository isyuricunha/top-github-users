...
The `public contributions` and `private contributions` by users in Spain on `2022/12/26 2:38 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
