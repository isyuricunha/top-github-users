...
The `public contributions` and `private contributions` by users in Spain on `2022/11/26 9:02 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
