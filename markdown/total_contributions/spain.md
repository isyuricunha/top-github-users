...
The `public contributions` and `private contributions` by users in Spain on `2022/11/28 8:24 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
