...
The `public contributions` and `private contributions` by users in Spain on `2022/11/8 8:55 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
