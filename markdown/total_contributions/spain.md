...
The `public contributions` and `private contributions` by users in Spain on `2024/6/5 2:38 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.
