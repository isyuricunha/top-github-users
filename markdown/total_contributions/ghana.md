...
The `public contributions` and `private contributions` by users in Ghana on `2024/4/18 10:33 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
