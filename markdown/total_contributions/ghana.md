...
The `public contributions` and `private contributions` by users in Ghana on `2025/1/1 7:58 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
