...
The `public contributions` and `private contributions` by users in Ghana on `2023/7/23 7:55 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Mike47ip">
				<img src="https://avatars.githubusercontent.com/u/122385966?s=72&v=4" width="24" alt="Avatar of Mike47ip"> Mike47ip
			</a><br/>
			MIKE
		</td>
		<td>Ipex </td>
