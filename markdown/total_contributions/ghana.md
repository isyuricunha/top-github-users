...
The `public contributions` and `private contributions` by users in Ghana on `2023/6/20 9:16 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Kel-Papa">
				<img src="https://avatars.githubusercontent.com/u/136039792?s=72&v=4" width="24" alt="Avatar of Kel-Papa"> Kel-Papa
			</a><br/>
