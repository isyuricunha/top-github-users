...
The `public contributions` and `private contributions` by users in Ghana on `2024/2/21 6:35 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
