...
The `public contributions` and `private contributions` by users in Burundi on `2022/12/30 4:35 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
