...
The `public contributions` and `private contributions` by users in Vietnam on `2024/5/8 5:42 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
