...
The `public contributions` and `private contributions` by users in Vietnam on `2025/1/16 5:38 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
