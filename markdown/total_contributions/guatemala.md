...
The `public contributions` and `private contributions` by users in Guatemala on `2022/11/25 10:44 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
