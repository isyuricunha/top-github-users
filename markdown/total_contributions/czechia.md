...
The `public contributions` and `private contributions` by users in Czechia on `2023/6/9 9:56 PM UTC`. This list contains users from `Czechia` and cities `Prague` `Brno` `Ostrava` `Pilsen` `Olomouc`.
...
<table>
	...
	<tr>
		...
		<td>@facultyai  </td>
		<td><a href="https://twitter.com/tommilata">tommilata</a></td>
		<td>Czechia or London, UK</td>
		<td>17</td>
		<td>17</td>
	</tr>
	<tr>
