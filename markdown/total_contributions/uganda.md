...
The `public contributions` and `private contributions` by users in Uganda on `2024/6/27 4:40 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
