...
The `public contributions` and `private contributions` by users in Uganda on `2024/10/12 3:56 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `974 users`  in Uganda. You need at least `8 followers` to be on this list.
