...
The `public contributions` and `private contributions` by users in Uganda on `2023/10/11 3:31 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
