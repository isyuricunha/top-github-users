...
The `public contributions` and `private contributions` by users in Uganda on `2024/12/8 7:45 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
