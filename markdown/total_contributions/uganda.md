...
The `public contributions` and `private contributions` by users in Uganda on `2023/8/19 3:41 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
