...
The `public contributions` and `private contributions` by users in Uganda on `2023/11/5 3:29 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
