...
The `public contributions` and `private contributions` by users in Uganda on `2023/1/21 12:58 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
