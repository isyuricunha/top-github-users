...
The `public contributions` and `private contributions` by users in Uganda on `2023/7/29 7:25 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
