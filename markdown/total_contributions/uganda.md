...
The `public contributions` and `private contributions` by users in Uganda on `2022/12/30 6:56 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
