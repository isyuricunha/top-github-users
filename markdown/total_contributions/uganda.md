...
The `public contributions` and `private contributions` by users in Uganda on `2022/11/18 8:50 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
