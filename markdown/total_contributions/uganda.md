...
The `public contributions` and `private contributions` by users in Uganda on `2023/12/15 6:37 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.
