...
The `public contributions` and `private contributions` by users in Lithuania on `2024/11/7 2:48 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
