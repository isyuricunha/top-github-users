...
The `public contributions` and `private contributions` by users in Lithuania on `2023/7/11 2:28 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
