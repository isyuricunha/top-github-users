...
The `public contributions` and `private contributions` by users in Lithuania on `2024/5/2 8:33 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
