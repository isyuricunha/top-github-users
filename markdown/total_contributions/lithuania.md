...
The `public contributions` and `private contributions` by users in Lithuania on `2024/9/6 2:58 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
