...
The `public contributions` and `private contributions` by users in Lithuania on `2023/2/4 6:56 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
