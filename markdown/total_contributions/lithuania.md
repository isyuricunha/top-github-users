...
The `public contributions` and `private contributions` by users in Lithuania on `2022/11/20 4:29 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
