...
The `public contributions` and `private contributions` by users in Iraq on `2024/9/11 4:22 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
