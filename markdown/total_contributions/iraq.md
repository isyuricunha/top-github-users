...
The `public contributions` and `private contributions` by users in Iraq on `2026/1/14 1:17 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
