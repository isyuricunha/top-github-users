...
The `public contributions` and `private contributions` by users in Iraq on `2025/2/25 12:44 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
