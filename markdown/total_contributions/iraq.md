...
The `public contributions` and `private contributions` by users in Iraq on `2024/5/2 4:56 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
