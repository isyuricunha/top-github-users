...
The `public contributions` and `private contributions` by users in Iraq on `2023/8/30 6:19 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
