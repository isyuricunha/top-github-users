...
The `public contributions` and `private contributions` by users in Iraq on `2023/2/20 1:03 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
