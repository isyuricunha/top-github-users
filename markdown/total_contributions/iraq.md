...
The `public contributions` and `private contributions` by users in Iraq on `2024/12/7 7:00 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
