...
The `public contributions` and `private contributions` by users in Iraq on `2024/2/1 4:43 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
