...
The `public contributions` and `private contributions` by users in Iraq on `2025/1/19 8:57 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
