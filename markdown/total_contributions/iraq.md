...
The `public contributions` and `private contributions` by users in Iraq on `2024/3/17 9:40 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
