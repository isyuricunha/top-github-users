...
The `public contributions` and `private contributions` by users in Iraq on `2024/6/29 8:17 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
