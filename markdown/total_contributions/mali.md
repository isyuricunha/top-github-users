...
The `public contributions` and `private contributions` by users in Mali on `2023/3/22 2:05 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
