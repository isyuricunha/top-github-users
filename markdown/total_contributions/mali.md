...
The `public contributions` and `private contributions` by users in Mali on `2024/12/9 4:20 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
