...
The `public contributions` and `private contributions` by users in Mali on `2023/7/3 1:30 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
