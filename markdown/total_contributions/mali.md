...
The `public contributions` and `private contributions` by users in Mali on `2024/11/13 5:32 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
