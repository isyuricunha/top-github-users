...
The `public contributions` and `private contributions` by users in Mali on `2024/5/23 4:34 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
