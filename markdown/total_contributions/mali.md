...
The `public contributions` and `private contributions` by users in Mali on `2023/12/24 6:13 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
...
<table>
	...
	<tr>
		<td>177</td>
		<td>
			<a href="https://github.com/henssculor">
				<img src="https://avatars.githubusercontent.com/u/154627554?s=72&v=4" width="24" alt="Avatar of henssculor"> henssculor
			</a><br/>
			Diedre
		</td>
		<td>No Company</td>
