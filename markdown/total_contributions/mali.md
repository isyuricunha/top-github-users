...
The `public contributions` and `private contributions` by users in Mali on `2023/4/21 7:36 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
