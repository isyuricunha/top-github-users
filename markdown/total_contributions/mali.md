...
The `public contributions` and `private contributions` by users in Mali on `2024/1/19 10:32 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
