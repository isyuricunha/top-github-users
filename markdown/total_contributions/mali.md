...
The `public contributions` and `private contributions` by users in Mali on `2023/3/7 2:40 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
