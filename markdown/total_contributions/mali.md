...
The `public contributions` and `private contributions` by users in Mali on `2023/9/17 4:12 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
