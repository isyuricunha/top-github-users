...
The `public contributions` and `private contributions` by users in Mali on `2024/4/3 7:24 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
