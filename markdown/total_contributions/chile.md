...
The `public contributions` and `private contributions` by users in Chile on `2022/11/17 9:58 AM UTC`. This list contains users from `Chile` and cities `Santiago` `Valparaíso` `Viña-del-mar` `Arica` `Temuco` `Concepcion` `Puerto-montt`.
