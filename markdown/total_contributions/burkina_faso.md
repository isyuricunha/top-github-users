...
The `public contributions` and `private contributions` by users in Burkina Faso on `2022/11/5 3:51 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
