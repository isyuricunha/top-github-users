...
The `public contributions` and `private contributions` by users in Belgium on `2024/11/25 11:00 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
