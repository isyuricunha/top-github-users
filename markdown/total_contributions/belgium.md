...
The `public contributions` and `private contributions` by users in Belgium on `2022/12/18 5:19 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
