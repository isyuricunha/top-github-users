...
The `public contributions` and `private contributions` by users in United Arab Emirates on `2023/9/29 11:48 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			Emirates ID Official
		</td>
		<td>Emirates Id Official </td>
		<td>No Twitter Username</td>
		<td>Dubai</td>
		<td>2</td>
		<td>2</td>
