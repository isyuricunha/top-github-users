...
The `public contributions` and `private contributions` by users in Nicaragua on `2022/11/22 2:18 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
