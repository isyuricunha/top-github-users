...
The `public contributions` and `private contributions` by users in Zambia on `2023/12/23 7:40 PM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.
...
<table>
	...
	<tr>
		<td>512</td>
		<td>
			<a href="https://github.com/wordnurlarr">
				<img src="https://avatars.githubusercontent.com/u/154698718?s=72&v=4" width="24" alt="Avatar of wordnurlarr"> wordnurlarr
			</a><br/>
			Tad
		</td>
		<td>No Company</td>
