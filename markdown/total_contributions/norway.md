...
The `public contributions` and `private contributions` by users in Norway on `2024/6/14 7:43 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
