...
The `public contributions` and `private contributions` by users in Norway on `2023/3/27 8:42 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
