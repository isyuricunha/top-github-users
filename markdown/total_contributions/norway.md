...
The `public contributions` and `private contributions` by users in Norway on `2023/9/19 2:36 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
