...
The `public contributions` and `private contributions` by users in Norway on `2023/8/27 8:56 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
