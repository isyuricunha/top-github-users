...
The `public contributions` and `private contributions` by users in Norway on `2023/10/14 2:16 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
