...
The `public contributions` and `private contributions` by users in Norway on `2023/1/30 12:56 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
