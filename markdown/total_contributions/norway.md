...
The `public contributions` and `private contributions` by users in Norway on `2023/1/21 3:07 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
