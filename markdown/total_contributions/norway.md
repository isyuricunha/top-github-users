...
The `public contributions` and `private contributions` by users in Norway on `2024/11/13 10:42 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
