...
The `public contributions` and `private contributions` by users in Norway on `2023/4/20 8:21 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
