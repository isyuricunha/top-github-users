...
The `public contributions` and `private contributions` by users in Norway on `2023/7/20 11:44 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
