...
The `public contributions` and `private contributions` by users in Norway on `2023/11/15 11:18 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
