...
The `public contributions` and `private contributions` by users in Norway on `2024/8/14 9:44 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
