...
The `public contributions` and `private contributions` by users in Norway on `2023/11/29 6:39 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
