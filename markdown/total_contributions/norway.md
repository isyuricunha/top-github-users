...
The `public contributions` and `private contributions` by users in Norway on `2024/6/21 9:58 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
