...
The `public contributions` and `private contributions` by users in Norway on `2024/5/6 1:47 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
