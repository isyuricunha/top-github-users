...
The `public contributions` and `private contributions` by users in Norway on `2024/7/21 11:59 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
