...
The `public contributions` and `private contributions` by users in Norway on `2024/4/6 7:56 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
