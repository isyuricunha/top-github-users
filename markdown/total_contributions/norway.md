...
The `public contributions` and `private contributions` by users in Norway on `2024/12/14 4:45 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
