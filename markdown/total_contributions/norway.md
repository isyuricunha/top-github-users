...
The `public contributions` and `private contributions` by users in Norway on `2023/5/25 8:01 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
