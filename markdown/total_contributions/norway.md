...
The `public contributions` and `private contributions` by users in Norway on `2022/11/30 11:34 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
