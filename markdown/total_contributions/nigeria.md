...
The `public contributions` and `private contributions` by users in Nigeria on `2025/1/20 9:23 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
