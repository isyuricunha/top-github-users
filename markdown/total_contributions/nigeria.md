...
The `public contributions` and `private contributions` by users in Nigeria on `2024/2/25 2:56 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
