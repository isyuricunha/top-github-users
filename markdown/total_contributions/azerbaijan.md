...
The `public contributions` and `private contributions` by users in Azerbaijan on `2025/1/23 3:21 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
...
<table>
	...
	<tr>
		...
		<td>Baku, Nizami, Azar Manafav 1</td>
		<td>222</td>
		<td>222</td>
	</tr>
	<tr>
