...
The `public contributions` and `private contributions` by users in Azerbaijan on `2023/12/3 9:28 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AfigAliyev">
				<img src="https://avatars.githubusercontent.com/u/91663102?s=72&v=4" width="24" alt="Avatar of AfigAliyev"> AfigAliyev
			</a><br/>
			Afig Aliyev
		</td>
