...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/6/18 12:58 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
