...
The `public contributions` and `private contributions` by users in Malaysia on `2024/8/7 8:23 AM UTC`. This list contains users from `Malaysia` and cities `Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`.
...
<table>
	...
	<tr>
		<td>758</td>
		<td>
			<a href="https://github.com/fahimanizam">
				<img src="https://avatars.githubusercontent.com/u/52328693?s=72&v=4" width="24" alt="Avatar of fahimanizam"> fahimanizam
			</a><br/>
			Fahima Nizam Nova
		</td>
		<td>Orsted </td>
