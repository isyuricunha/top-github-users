...
The `public contributions` and `private contributions` by users in Armenia on `2023/2/27 5:33 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
