...
The `public contributions` and `private contributions` by users in Bahrain on `2023/4/12 2:15 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.
