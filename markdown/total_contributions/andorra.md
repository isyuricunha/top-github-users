...
The `public contributions` and `private contributions` by users in Andorra on `2022/11/27 6:50 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/J0stGeorge">
				<img src="https://avatars.githubusercontent.com/u/107973259?s=72&u=6e7ecaab1bd510c444c78772670a5b03208366d4&v=4" width="24" alt="Avatar of J0stGeorge"> J0stGeorge
			</a><br/>
			CodingAllTime
		</td>
		<td>No Company</td>
