...
The `public contributions` and `private contributions` by users in Andorra on `2023/4/17 12:53 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/J0stGeorge">
				<img src="https://avatars.githubusercontent.com/u/107973259?s=72&u=e060f02755eac864fdbcd59ab6a6c9691d0528c6&v=4" width="24" alt="Avatar of J0stGeorge"> J0stGeorge
			</a><br/>
			CodingAllTime
		</td>
		<td>No Company</td>
