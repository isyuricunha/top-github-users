...
The `public contributions` and `private contributions` by users in Andorra on `2025/4/9 12:41 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
...
<table>
	...
	<tr>
		<td>171</td>
		<td>
			<a href="https://github.com/marcotorguet">
				<img src="https://avatars.githubusercontent.com/u/166648031?s=72&v=4" width="24" alt="Avatar of marcotorguet"> marcotorguet
			</a><br/>
			Marco T
		</td>
		<td>No Company</td>
