...
The `public contributions` and `private contributions` by users in Finland on `2025/1/12 7:18 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
