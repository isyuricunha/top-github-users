...
The `public contributions` and `private contributions` by users in Finland on `2024/12/13 9:59 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
