...
The `public contributions` and `private contributions` by users in Finland on `2023/6/18 3:29 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
