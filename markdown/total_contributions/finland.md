...
The `public contributions` and `private contributions` by users in Finland on `2022/12/3 3:36 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
