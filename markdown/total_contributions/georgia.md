...
The `public contributions` and `private contributions` by users in Georgia on `2023/11/16 3:33 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
