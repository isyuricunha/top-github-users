...
The `public contributions` and `private contributions` by users in Georgia on `2023/8/10 4:19 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
