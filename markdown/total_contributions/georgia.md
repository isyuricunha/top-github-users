...
The `public contributions` and `private contributions` by users in Georgia on `2022/12/13 3:57 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
