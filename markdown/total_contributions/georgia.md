...
The `public contributions` and `private contributions` by users in Georgia on `2023/2/27 5:35 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
