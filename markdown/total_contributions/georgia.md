...
The `public contributions` and `private contributions` by users in Georgia on `2024/6/18 11:57 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
