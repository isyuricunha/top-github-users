...
The `public contributions` and `private contributions` by users in Georgia on `2024/9/3 6:56 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
