...
The `public contributions` and `private contributions` by users in Georgia on `2024/10/23 5:20 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
