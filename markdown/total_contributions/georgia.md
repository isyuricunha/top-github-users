...
The `public contributions` and `private contributions` by users in Georgia on `2023/12/24 10:35 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
