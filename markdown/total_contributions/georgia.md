...
The `public contributions` and `private contributions` by users in Georgia on `2022/11/10 11:39 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
