...
The `public contributions` and `private contributions` by users in Georgia on `2025/1/12 7:57 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
