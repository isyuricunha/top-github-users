...
The `public contributions` and `private contributions` by users in Georgia on `2023/10/12 8:36 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
