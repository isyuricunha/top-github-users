...
The `public contributions` and `private contributions` by users in Georgia on `2022/12/1 7:43 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
