...
The `public contributions` and `private contributions` by users in Georgia on `2023/7/19 9:28 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
