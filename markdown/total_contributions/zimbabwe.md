...
The `public contributions` and `private contributions` by users in Zimbabwe on `2022/11/12 11:55 AM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.
