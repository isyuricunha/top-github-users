...
The `public contributions` and `private contributions` by users in Kenya on `2024/6/19 7:43 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
