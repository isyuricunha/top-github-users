...
The `public contributions` and `private contributions` by users in Egypt on `2024/1/1 3:41 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
