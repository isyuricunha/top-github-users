...
The `public contributions` and `private contributions` by users in Egypt on `2025/7/12 12:53 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
