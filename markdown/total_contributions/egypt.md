...
The `public contributions` and `private contributions` by users in Egypt on `2024/3/8 9:56 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
