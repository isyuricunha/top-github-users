...
The `public contributions` and `private contributions` by users in New Zealand on `2023/7/30 10:56 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
