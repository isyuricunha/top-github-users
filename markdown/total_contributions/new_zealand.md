...
The `public contributions` and `private contributions` by users in New Zealand on `2022/11/16 7:03 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
