...
The `public contributions` and `private contributions` by users in New Zealand on `2023/2/22 6:40 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.
