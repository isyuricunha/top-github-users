...
The `public contributions` and `private contributions` by users in Brazil on `2023/12/8 6:39 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Amadeo-Frontend">
				<img src="https://avatars.githubusercontent.com/u/104178969?s=72&u=1fd258f9e70e6c1c16b6a839bf547658221b1d8e&v=4" width="24" alt="Avatar of Amadeo-Frontend"> Amadeo-Frontend
			</a><br/>
			AmadeoBon
		</td>
