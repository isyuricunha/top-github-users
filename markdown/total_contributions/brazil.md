...
The `public contributions` and `private contributions` by users in Brazil on `2024/1/9 10:58 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/MarleneMoraes">
				<img src="https://avatars.githubusercontent.com/u/72894890?s=72&u=5b9f48b864ca8a57390f122720c21681fac0860b&v=4" width="24" alt="Avatar of MarleneMoraes"> MarleneMoraes
			</a><br/>
			Marlene Moraes
		</td>
		<td>Google </td>
