...
The `public contributions` and `private contributions` by users in Brazil on `2023/6/23 11:57 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `966 users`  in Brazil. You need at least `194 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/amaurybsouza">
				<img src="https://avatars.githubusercontent.com/u/36505926?s=72&u=bbbe8ca4930a8c36b38dcda47047413aa2da8ff7&v=4" width="24" alt="Avatar of amaurybsouza"> amaurybsouza
			</a><br/>
			Amaury Borges Souza
		</td>
		<td>@kyndryl </td>
