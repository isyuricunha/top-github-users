...
The `public contributions` and `private contributions` by users in Brazil on `2023/6/19 11:32 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Wellers0n">
				<img src="https://avatars.githubusercontent.com/u/39449389?s=72&u=b96c908277b5c70de61c2740a478749eedbbf010&v=4" width="24" alt="Avatar of Wellers0n"> Wellers0n
			</a><br/>
			Wellerson
		</td>
		<td>No Company</td>
