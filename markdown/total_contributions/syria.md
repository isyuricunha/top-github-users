...
The `public contributions` and `private contributions` by users in Syria on `2022/12/8 11:29 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
