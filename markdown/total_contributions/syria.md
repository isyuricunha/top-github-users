...
The `public contributions` and `private contributions` by users in Syria on `2023/11/19 6:17 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
