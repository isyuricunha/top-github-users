...
The `public contributions` and `private contributions` by users in Syria on `2022/12/15 11:40 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
