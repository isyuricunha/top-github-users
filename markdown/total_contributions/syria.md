...
The `public contributions` and `private contributions` by users in Syria on `2023/6/14 10:33 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
