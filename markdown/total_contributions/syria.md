...
The `public contributions` and `private contributions` by users in Syria on `2023/5/10 11:29 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
