...
The `public contributions` and `private contributions` by users in Syria on `2022/12/30 5:31 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
