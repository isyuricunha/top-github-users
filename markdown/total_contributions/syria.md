...
The `public contributions` and `private contributions` by users in Syria on `2023/7/6 1:08 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
