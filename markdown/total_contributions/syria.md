...
The `public contributions` and `private contributions` by users in Syria on `2024/10/20 5:35 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
