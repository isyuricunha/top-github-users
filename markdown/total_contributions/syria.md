...
The `public contributions` and `private contributions` by users in Syria on `2022/11/8 11:47 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
