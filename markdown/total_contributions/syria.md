...
The `public contributions` and `private contributions` by users in Syria on `2023/1/30 10:36 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
