...
The `public contributions` and `private contributions` by users in Syria on `2023/8/19 2:27 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
