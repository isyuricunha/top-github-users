...
The `public contributions` and `private contributions` by users in Syria on `2023/12/28 4:47 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
