...
The `public contributions` and `private contributions` by users in Taiwan on `2023/10/10 11:17 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
