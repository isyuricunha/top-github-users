...
The `public contributions` and `private contributions` by users in Taiwan on `2024/10/27 1:45 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
