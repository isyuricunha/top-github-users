...
The `public contributions` and `private contributions` by users in Taiwan on `2023/8/28 5:56 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
