...
The `public contributions` and `private contributions` by users in Taiwan on `2024/5/12 2:56 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
