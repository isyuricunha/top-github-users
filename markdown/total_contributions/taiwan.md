...
The `public contributions` and `private contributions` by users in Taiwan on `2024/6/20 2:35 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
