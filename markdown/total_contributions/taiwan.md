...
The `public contributions` and `private contributions` by users in Taiwan on `2022/12/9 3:45 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
