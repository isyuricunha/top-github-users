...
The `public contributions` and `private contributions` by users in Taiwan on `2023/11/4 11:27 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
