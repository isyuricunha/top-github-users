...
The `public contributions` and `private contributions` by users in Taiwan on `2022/11/25 4:52 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
