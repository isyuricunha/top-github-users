...
The `public contributions` and `private contributions` by users in Taiwan on `2023/7/19 5:32 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
