...
The `public contributions` and `private contributions` by users in Taiwan on `2023/4/29 5:56 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
