...
The `public contributions` and `private contributions` by users in Taiwan on `2023/1/18 8:58 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
