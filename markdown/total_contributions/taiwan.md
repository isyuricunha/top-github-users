...
The `public contributions` and `private contributions` by users in Taiwan on `2025/1/19 10:00 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
