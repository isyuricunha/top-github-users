...
The `public contributions` and `private contributions` by users in Taiwan on `2023/1/31 1:02 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
