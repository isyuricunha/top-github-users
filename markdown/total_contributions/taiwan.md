...
The `public contributions` and `private contributions` by users in Taiwan on `2023/1/7 1:00 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
