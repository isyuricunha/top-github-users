...
The `public contributions` and `private contributions` by users in Taiwan on `2023/3/3 10:39 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
