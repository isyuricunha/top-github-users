...
The `public contributions` and `private contributions` by users in Taiwan on `2024/8/17 6:39 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
