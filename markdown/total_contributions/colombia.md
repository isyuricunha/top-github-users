...
The `public contributions` and `private contributions` by users in Colombia on `2023/9/3 8:41 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
