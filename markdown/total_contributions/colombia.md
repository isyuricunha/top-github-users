...
The `public contributions` and `private contributions` by users in Colombia on `2022/12/1 3:21 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
