...
The `public contributions` and `private contributions` by users in Colombia on `2024/9/3 2:19 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
