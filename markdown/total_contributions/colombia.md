...
The `public contributions` and `private contributions` by users in Colombia on `2024/11/15 4:45 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
