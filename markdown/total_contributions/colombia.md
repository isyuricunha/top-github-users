...
The `public contributions` and `private contributions` by users in Colombia on `2023/10/18 6:37 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
