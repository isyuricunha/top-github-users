...
The `public contributions` and `private contributions` by users in Colombia on `2023/11/6 4:19 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
