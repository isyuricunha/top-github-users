...
The `public contributions` and `private contributions` by users in Colombia on `2025/9/15 12:50 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
