...
The `public contributions` and `private contributions` by users in Colombia on `2024/7/13 7:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
