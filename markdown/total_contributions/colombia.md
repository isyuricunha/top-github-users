...
The `public contributions` and `private contributions` by users in Colombia on `2023/10/10 11:27 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
