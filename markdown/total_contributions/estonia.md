...
The `public contributions` and `private contributions` by users in Estonia on `2024/7/17 4:43 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/hatemets">
				<img src="https://avatars.githubusercontent.com/u/17316944?s=72&u=4deeb45410bed008982a7d09d845867db8ff5bc0&v=4" width="24" alt="Avatar of hatemets"> hatemets
			</a><br/>
			Mark Heidmets
		</td>
		<td>No Company</td>
