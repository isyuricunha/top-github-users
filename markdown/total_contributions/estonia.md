...
The `public contributions` and `private contributions` by users in Estonia on `2022/12/7 9:40 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.
