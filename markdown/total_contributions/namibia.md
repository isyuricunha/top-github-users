...
The `public contributions` and `private contributions` by users in Namibia on `2023/3/16 10:40 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
