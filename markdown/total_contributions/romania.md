...
The `public contributions` and `private contributions` by users in Romania on `2023/7/16 10:44 PM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/StefanSelfTaught">
				<img src="https://avatars.githubusercontent.com/u/43994418?s=72&v=4" width="24" alt="Avatar of StefanSelfTaught"> StefanSelfTaught
			</a><br/>
			Stefan Pop
		</td>
		<td>No Company</td>
