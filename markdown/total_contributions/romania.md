...
The `public contributions` and `private contributions` by users in Romania on `2024/1/25 2:52 AM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cossssmin">
				<img src="https://avatars.githubusercontent.com/u/1656595?s=72&u=3b247b74ef92cfdb7c375ec1cea43dada5297952&v=4" width="24" alt="Avatar of cossssmin"> cossssmin
			</a><br/>
			Cosmin Popovici
		</td>
		<td>No Company</td>
