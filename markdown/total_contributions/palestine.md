...
The `public contributions` and `private contributions` by users in Palestine on `2024/8/2 3:55 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
