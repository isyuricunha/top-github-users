...
The `public contributions` and `private contributions` by users in Palestine on `2024/11/20 9:56 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
