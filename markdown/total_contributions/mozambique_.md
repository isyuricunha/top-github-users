...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/6/12 5:16 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
