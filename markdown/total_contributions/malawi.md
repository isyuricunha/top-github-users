...
The `public contributions` and `private contributions` by users in Malawi on `2022/12/27 6:45 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
