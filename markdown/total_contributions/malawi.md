...
The `public contributions` and `private contributions` by users in Malawi on `2024/6/10 9:19 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		<td>323</td>
		<td>
			<a href="https://github.com/pmphande">
				<img src="https://avatars.githubusercontent.com/u/157726353?s=72&v=4" width="24" alt="Avatar of pmphande"> pmphande
			</a><br/>
			Philmon Chimaliro Mphande
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/MphandePhi7447">MphandePhi7447</a></td>
		<td>Lilongwe</td>
		<td>10</td>
		<td>10</td>
	</tr>
