...
The `public contributions` and `private contributions` by users in Morocco on `2024/7/1 9:56 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/wahidsaidmaroc">
				<img src="https://avatars.githubusercontent.com/u/21662127?s=72&v=4" width="24" alt="Avatar of wahidsaidmaroc"> wahidsaidmaroc
			</a><br/>
			saidwahid
		</td>
		<td>@oumdin </td>
