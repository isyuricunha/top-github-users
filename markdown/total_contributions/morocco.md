...
The `public contributions` and `private contributions` by users in Morocco on `2024/10/26 8:57 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/aelassas">
				<img src="https://avatars.githubusercontent.com/u/1339626?s=72&v=4" width="24" alt="Avatar of aelassas"> aelassas
			</a><br/>
			No Name
		</td>
		<td>Teradev </td>
		<td><a href="https://twitter.com/aelassas08">aelassas08</a></td>
		<td>Morocco</td>
		<td>1734</td>
		<td>2933</td>
	</tr>
