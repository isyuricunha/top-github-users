...
The `public contributions` and `private contributions` by users in Morocco on `2024/11/9 6:56 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Simofatt">
				<img src="https://avatars.githubusercontent.com/u/100781782?s=72&u=2aa2c138c23e99a733f64a6e7e448d27f9d1486a&v=4" width="24" alt="Avatar of Simofatt"> Simofatt
			</a><br/>
			Habib 
		</td>
		<td>No Company</td>
