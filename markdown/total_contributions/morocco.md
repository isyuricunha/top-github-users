...
The `public contributions` and `private contributions` by users in Morocco on `2024/7/23 5:56 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/TAFFAHACHRAF">
				<img src="https://avatars.githubusercontent.com/u/99338171?s=72&v=4" width="24" alt="Avatar of TAFFAHACHRAF"> TAFFAHACHRAF
			</a><br/>
			Achraf Taffah
		</td>
