...
The `public contributions` and `private contributions` by users in Tanzania on `2025/6/14 12:47 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
