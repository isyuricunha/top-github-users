...
The `public contributions` and `private contributions` by users in Tanzania on `2024/10/20 5:46 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
