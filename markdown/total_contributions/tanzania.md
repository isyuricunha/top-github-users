...
The `public contributions` and `private contributions` by users in Tanzania on `2024/8/22 6:21 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
...
<table>
	...
	<tr>
		<td>235</td>
		<td>
			<a href="https://github.com/oxokod">
				<img src="https://avatars.githubusercontent.com/u/53156953?s=72&v=4" width="24" alt="Avatar of oxokod"> oxokod
			</a><br/>
			oXoKod
		</td>
		<td>@mafasystems </td>
