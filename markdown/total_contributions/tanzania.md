...
The `public contributions` and `private contributions` by users in Tanzania on `2023/9/13 7:27 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `944 users`  in Tanzania. You need at least `3 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Kadilana">
				<img src="https://avatars.githubusercontent.com/u/119741778?s=72&v=4" width="24" alt="Avatar of Kadilana"> Kadilana
			</a><br/>
			Kadilana Charles
		</td>
		<td>X-nova </td>
