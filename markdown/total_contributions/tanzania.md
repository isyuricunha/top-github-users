...
The `public contributions` and `private contributions` by users in Tanzania on `2023/12/1 9:41 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
