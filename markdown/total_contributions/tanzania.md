...
The `public contributions` and `private contributions` by users in Tanzania on `2024/6/30 3:32 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
