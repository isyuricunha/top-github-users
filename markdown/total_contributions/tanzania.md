...
The `public contributions` and `private contributions` by users in Tanzania on `2024/9/24 5:38 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
