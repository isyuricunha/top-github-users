...
The `public contributions` and `private contributions` by users in Tanzania on `2023/8/6 12:21 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
