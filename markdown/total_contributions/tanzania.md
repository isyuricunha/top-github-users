...
The `public contributions` and `private contributions` by users in Tanzania on `2024/3/28 4:18 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
