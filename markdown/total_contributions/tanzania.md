...
The `public contributions` and `private contributions` by users in Tanzania on `2024/9/20 7:42 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
