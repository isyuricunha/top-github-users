...
The `public contributions` and `private contributions` by users in Tanzania on `2024/8/28 7:43 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
