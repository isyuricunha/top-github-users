...
The `public contributions` and `private contributions` by users in Tanzania on `2024/8/2 12:58 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
