...
The `public contributions` and `private contributions` by users in Oman on `2024/3/29 12:23 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/asma-alhadhrami">
				<img src="https://avatars.githubusercontent.com/u/165217470?s=72&v=4" width="24" alt="Avatar of asma-alhadhrami"> asma-alhadhrami
			</a><br/>
			Asma Al Hadhrami
		</td>
		<td>No Company</td>
