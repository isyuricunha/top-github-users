...
The `public contributions` and `private contributions` by users in Oman on `2023/8/12 7:24 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/KhalidaDeveloper">
				<img src="https://avatars.githubusercontent.com/u/139890979?s=72&v=4" width="24" alt="Avatar of KhalidaDeveloper"> KhalidaDeveloper
			</a><br/>
			Khalida Al Jardani
		</td>
		<td>Udacity </td>
