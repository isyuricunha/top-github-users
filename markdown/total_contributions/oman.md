...
The `public contributions` and `private contributions` by users in Oman on `2022/11/18 10:18 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `897 users`  in Oman. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/sparklinematrix">
				<img src="https://avatars.githubusercontent.com/u/117560495?s=72&u=e0bcae6e044520983f526e4e001fed31e617c1e0&v=4" width="24" alt="Avatar of sparklinematrix"> sparklinematrix
			</a><br/>
			SparkLine Matrix
		</td>
