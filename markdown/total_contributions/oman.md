...
The `public contributions` and `private contributions` by users in Oman on `2023/12/13 3:17 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		<td>422</td>
		<td>
			<a href="https://github.com/Polyglotinstitute">
				<img src="https://avatars.githubusercontent.com/u/153496559?s=72&v=4" width="24" alt="Avatar of Polyglotinstitute"> Polyglotinstitute
			</a><br/>
			Polyglot Institute
		</td>
		<td>Polyglotinstitute </td>
		<td>No Twitter Username</td>
		<td>Muscat,Oman</td>
		<td>1</td>
		<td>1</td>
