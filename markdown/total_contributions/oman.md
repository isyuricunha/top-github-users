...
The `public contributions` and `private contributions` by users in Oman on `2022/12/11 7:39 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
