...
The `public contributions` and `private contributions` by users in Oman on `2022/12/6 4:54 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `909 users`  in Oman. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/hansperm">
				<img src="https://avatars.githubusercontent.com/u/119885838?s=72&v=4" width="24" alt="Avatar of hansperm"> hansperm
			</a><br/>
			Hansel Delos santos
		</td>
		<td>Utas </td>
