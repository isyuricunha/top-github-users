...
The `public contributions` and `private contributions` by users in Oman on `2023/8/1 4:32 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Mariya-9">
				<img src="https://avatars.githubusercontent.com/u/136194312?s=72&v=4" width="24" alt="Avatar of Mariya-9"> Mariya-9
			</a><br/>
			MARIYA AL ALAWI
		</td>
		<td>No Company</td>
