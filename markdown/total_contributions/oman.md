...
The `public contributions` and `private contributions` by users in Oman on `2023/8/25 6:17 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		<td>94</td>
		<td>
			<a href="https://github.com/yazanmacki">
				<img src="https://avatars.githubusercontent.com/u/114377811?s=72&v=4" width="24" alt="Avatar of yazanmacki"> yazanmacki
			</a><br/>
			Yazan Al Macki
		</td>
		<td>No Company</td>
