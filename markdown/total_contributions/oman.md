...
The `public contributions` and `private contributions` by users in Oman on `2023/8/20 8:14 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		<td>311</td>
		<td>
			<a href="https://github.com/Alkhlood">
				<img src="https://avatars.githubusercontent.com/u/77111501?s=72&v=4" width="24" alt="Avatar of Alkhlood"> Alkhlood
			</a><br/>
			No Name
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/AlkhloodAlskai1">AlkhloodAlskai1</a></td>
		<td>Oman</td>
		<td>4</td>
		<td>4</td>
	</tr>
