...
The `public contributions` and `private contributions` by users in Oman on `2023/7/22 5:53 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alsaidiIbrahim">
				<img src="https://avatars.githubusercontent.com/u/104320926?s=72&v=4" width="24" alt="Avatar of alsaidiIbrahim"> alsaidiIbrahim
			</a><br/>
			Ibrahim alsaidi
		</td>
