...
The `public contributions` and `private contributions` by users in Oman on `2023/8/7 7:13 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tasneemKhalfan">
				<img src="https://avatars.githubusercontent.com/u/138357629?s=72&v=4" width="24" alt="Avatar of tasneemKhalfan"> tasneemKhalfan
			</a><br/>
			Tasneem Khalfan
		</td>
		<td>No Company</td>
