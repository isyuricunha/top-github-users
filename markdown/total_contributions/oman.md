...
The `public contributions` and `private contributions` by users in Oman on `2024/1/21 10:16 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/suazhanif">
				<img src="https://avatars.githubusercontent.com/u/134514863?s=72&v=4" width="24" alt="Avatar of suazhanif"> suazhanif
			</a><br/>
			Suaz Hanif M.
		</td>
		<td>No Company</td>
