...
The `public contributions` and `private contributions` by users in Botswana on `2022/11/27 11:27 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>180</td>
		<td>
			<a href="https://github.com/aXp-TM">
				<img src="https://avatars.githubusercontent.com/u/73710136?s=72&v=4" width="24" alt="Avatar of aXp-TM"> aXp-TM
			</a><br/>
			Themba Matabiswana
		</td>
		<td>Axesspoint </td>
