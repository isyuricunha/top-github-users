...
The `public contributions` and `private contributions` by users in Ukraine on `2023/2/21 10:49 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
