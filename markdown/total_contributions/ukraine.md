...
The `public contributions` and `private contributions` by users in Ukraine on `2025/8/24 2:40 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
