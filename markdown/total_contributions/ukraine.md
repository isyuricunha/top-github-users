...
The `public contributions` and `private contributions` by users in Ukraine on `2024/6/23 3:41 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
