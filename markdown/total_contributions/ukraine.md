...
The `public contributions` and `private contributions` by users in Ukraine on `2023/7/29 7:41 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
