...
The `public contributions` and `private contributions` by users in Ukraine on `2023/10/18 6:47 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
