...
The `public contributions` and `private contributions` by users in Ukraine on `2023/9/15 2:17 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
