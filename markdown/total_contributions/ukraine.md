...
The `public contributions` and `private contributions` by users in Ukraine on `2024/7/2 12:59 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
