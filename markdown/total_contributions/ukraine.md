...
The `public contributions` and `private contributions` by users in Ukraine on `2023/6/24 10:36 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
