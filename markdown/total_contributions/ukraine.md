...
The `public contributions` and `private contributions` by users in Ukraine on `2022/12/19 2:53 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
