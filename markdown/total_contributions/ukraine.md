...
The `public contributions` and `private contributions` by users in Ukraine on `2023/11/12 11:42 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
