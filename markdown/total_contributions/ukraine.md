...
The `public contributions` and `private contributions` by users in Ukraine on `2022/11/23 5:14 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
