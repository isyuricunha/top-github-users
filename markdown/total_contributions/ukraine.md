...
The `public contributions` and `private contributions` by users in Ukraine on `2023/12/11 6:48 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
