...
The `public contributions` and `private contributions` by users in Ukraine on `2024/1/16 2:36 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
