...
The `public contributions` and `private contributions` by users in Ukraine on `2023/1/30 11:56 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
