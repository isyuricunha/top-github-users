...
The `public contributions` and `private contributions` by users in Ukraine on `2023/3/20 11:42 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
