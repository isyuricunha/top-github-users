...
The `public contributions` and `private contributions` by users in Ukraine on `2023/12/3 3:57 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
