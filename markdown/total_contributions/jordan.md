...
The `public contributions` and `private contributions` by users in Jordan on `2025/1/17 7:42 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
