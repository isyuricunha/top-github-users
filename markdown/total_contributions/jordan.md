...
The `public contributions` and `private contributions` by users in Jordan on `2023/9/2 3:41 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
