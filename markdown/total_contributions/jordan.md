...
The `public contributions` and `private contributions` by users in Jordan on `2024/2/11 1:40 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
