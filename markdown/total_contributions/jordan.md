...
The `public contributions` and `private contributions` by users in Jordan on `2023/6/10 6:55 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
