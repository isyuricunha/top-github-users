...
The `public contributions` and `private contributions` by users in Jordan on `2024/7/16 5:18 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
