...
The `public contributions` and `private contributions` by users in Jordan on `2026/1/20 1:14 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
