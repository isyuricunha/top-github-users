...
The `public contributions` and `private contributions` by users in Jordan on `2024/12/22 8:34 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
