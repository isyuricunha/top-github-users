...
The `public contributions` and `private contributions` by users in Poland on `2024/10/28 2:59 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
