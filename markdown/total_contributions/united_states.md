...
The `public contributions` and `private contributions` by users in United States on `2023/12/18 5:58 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `918 users`  in United States. You need at least `489 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/piemonte">
				<img src="https://avatars.githubusercontent.com/u/1870667?s=72&u=3bcc2ac7d531e334a0ceb40460ccc7adf8731e88&v=4" width="24" alt="Avatar of piemonte"> piemonte
			</a><br/>
			patrick piemonte
		</td>
		<td>No Company</td>
