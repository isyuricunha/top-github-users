...
The `public contributions` and `private contributions` by users in Iran on `2024/10/27 9:34 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `983 users`  in Iran. You need at least `68 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/itdevx">
				<img src="https://avatars.githubusercontent.com/u/73688061?s=72&u=31cf19513f86307a9dd519d63f1718676d4dfae2&v=4" width="24" alt="Avatar of itdevx"> itdevx
			</a><br/>
			Yasin Esmaeili
		</td>
		<td>No Company</td>
