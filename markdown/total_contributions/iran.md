...
The `public contributions` and `private contributions` by users in Iran on `2024/12/2 2:42 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/rabbal">
				<img src="https://avatars.githubusercontent.com/u/6818642?s=72&u=8ae577c257cbb43d8fc1b902c0dd2bbf181fcdd0&v=4" width="24" alt="Avatar of rabbal"> rabbal
			</a><br/>
			Salar Rabbal
		</td>
