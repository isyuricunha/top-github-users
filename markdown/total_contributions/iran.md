...
The `public contributions` and `private contributions` by users in Iran on `2023/6/6 4:19 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
