...
The `public contributions` and `private contributions` by users in Iran on `2024/10/5 3:56 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
