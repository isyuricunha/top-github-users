...
The `public contributions` and `private contributions` by users in Iran on `2024/11/13 11:18 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/faridfr">
				<img src="https://avatars.githubusercontent.com/u/9497923?s=72&u=e39d7eb9785e6b1e242ce2fd86c68344ffc25688&v=4" width="24" alt="Avatar of faridfr"> faridfr
			</a><br/>
			Farid Froozan
		</td>
		<td>@novaday-co </td>
