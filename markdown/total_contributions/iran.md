...
The `public contributions` and `private contributions` by users in Iran on `2022/11/26 2:27 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
