...
The `public contributions` and `private contributions` by users in Iran on `2024/12/28 8:56 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/amirhallaji">
				<img src="https://avatars.githubusercontent.com/u/47365462?s=72&u=652eb3c4394ad0897fdc122ad2968ea19f9af0ba&v=4" width="24" alt="Avatar of amirhallaji"> amirhallaji
			</a><br/>
			Amir Hallaji
		</td>
		<td>@snapp-cab </td>
