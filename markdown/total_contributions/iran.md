...
The `public contributions` and `private contributions` by users in Iran on `2024/10/25 10:19 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
...
<table>
	...
	<tr>
		<td>848</td>
		<td>
			<a href="https://github.com/Baharzrp9">
				<img src="https://avatars.githubusercontent.com/u/161215505?s=72&v=4" width="24" alt="Avatar of Baharzrp9"> Baharzrp9
			</a><br/>
			Bahar
		</td>
		<td>No Company</td>
