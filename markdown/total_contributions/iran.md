...
The `public contributions` and `private contributions` by users in Iran on `2024/9/17 9:20 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/amirallami-code">
				<img src="https://avatars.githubusercontent.com/u/123266762?s=72&u=4ff15d12a1cab680688cec30c469706c48622880&v=4" width="24" alt="Avatar of amirallami-code"> amirallami-code
			</a><br/>
			amirhossein allami
		</td>
		<td>Neurotract </td>
