...
The `public contributions` and `private contributions` by users in Iran on `2024/8/12 3:36 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
