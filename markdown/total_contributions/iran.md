...
The `public contributions` and `private contributions` by users in Iran on `2024/9/5 9:18 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
