...
The `public contributions` and `private contributions` by users in Iran on `2023/5/8 9:41 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
