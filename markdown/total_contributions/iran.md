...
The `public contributions` and `private contributions` by users in Iran on `2022/12/18 5:15 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
