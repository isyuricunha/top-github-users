...
The `public contributions` and `private contributions` by users in Iran on `2025/1/1 10:20 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

There are `138 countries` and `675 cities` can be found [here](https://github.com/isyuricunha/top-github-users).

There are `984 users`  in Iran. You need at least `76 followers` to be on this list.
