...
The `public contributions` and `private contributions` by users in Iran on `2023/1/14 10:55 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
