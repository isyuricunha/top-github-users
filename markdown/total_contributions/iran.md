...
The `public contributions` and `private contributions` by users in Iran on `2024/11/7 10:20 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
...
<table>
	...
	<tr>
		<td>214</td>
		<td>
			<a href="https://github.com/mahdiahbabi">
				<img src="https://avatars.githubusercontent.com/u/106030365?s=72&u=177ec2a42e199b888567051207bd890663a88f0a&v=4" width="24" alt="Avatar of mahdiahbabi"> mahdiahbabi
			</a><br/>
			Mahdi Ahbabi
		</td>
		<td>No Company</td>
