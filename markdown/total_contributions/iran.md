...
The `public contributions` and `private contributions` by users in Iran on `2025/1/12 11:19 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.
