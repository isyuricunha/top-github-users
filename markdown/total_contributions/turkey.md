...
The `public contributions` and `private contributions` by users in Turkey on `2024/12/19 5:37 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
