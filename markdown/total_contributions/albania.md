...
The `public contributions` and `private contributions` by users in Albania on `2023/12/25 1:31 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
