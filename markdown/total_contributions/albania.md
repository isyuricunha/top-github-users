...
The `public contributions` and `private contributions` by users in Albania on `2024/5/10 1:41 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
