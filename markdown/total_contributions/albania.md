...
The `public contributions` and `private contributions` by users in Albania on `2024/9/20 1:26 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
