...
The `public contributions` and `private contributions` by users in Dominican Republic on `2023/10/28 7:25 PM UTC`. This list contains users from `Dominican Republic` and cities `Santo-domingo` `Puerto-plata` `San-pedro-de-macoris` `Santiago-de-los-caballeros` `Higuey`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Victor-FMR">
				<img src="https://avatars.githubusercontent.com/u/105192432?s=72&v=4" width="24" alt="Avatar of Victor-FMR"> Victor-FMR
			</a><br/>
			Victor Martinez
		</td>
		<td>No Company</td>
