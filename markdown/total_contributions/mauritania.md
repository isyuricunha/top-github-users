...
The `public contributions` and `private contributions` by users in Mauritania on `2022/12/29 2:48 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
