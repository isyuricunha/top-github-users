...
The `public contributions` and `private contributions` by users in Mauritania on `2024/12/7 1:39 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
