...
The `public contributions` and `private contributions` by users in Mauritania on `2024/4/24 9:35 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
