...
The `public contributions` and `private contributions` by users in Mauritania on `2024/4/8 7:34 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
