...
The `public contributions` and `private contributions` by users in Mauritania on `2023/7/31 10:26 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
