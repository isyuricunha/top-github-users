...
The `public contributions` and `private contributions` by users in Mauritania on `2023/2/26 7:24 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
