...
The `public contributions` and `private contributions` by users in Mauritania on `2023/12/29 7:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
